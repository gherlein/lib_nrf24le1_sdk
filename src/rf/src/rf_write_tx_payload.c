...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// uint8_t rf_read_rx_payload(uint8_t * dataptr, uint16_t len, bool transmit)
//
// Description:
//  Writes the payload to the TX FIFO
//
// Parameters:
...
uint8_t rf_write_tx_payload(uint8_t * dataptr, uint16_t len, bool transmit)
{
	...
	status = rf_spi_execute_command(RF_W_TX_PAYLOAD_NOACK, dataptr, len, false); //Write the payload
