...
#define ADC_CONFIG_OPTION_ACQ_TIME_3_US							((0x01 << ADCCON2_ACQ_TIME_SHIFT) << ADC_CONFIG_OPTION_ADCCON2_OFFSET_SHIFT)		//Sets the ADC acquisition time to 13 us
#define ADC_CONFIG_OPTION_ACQ_TIME_12_US						((0x02 << ADCCON2_ACQ_TIME_SHIFT) << ADC_CONFIG_OPTION_ADCCON2_OFFSET_SHIFT)		//Sets the ADC acquisition time to 1012 us
#define ADC_CONFIG_OPTION_ACQ_TIME_36_US						((0x03 << ADCCON2_ACQ_TIME_SHIFT) << ADC_CONFIG_OPTION_ADCCON2_OFFSET_SHIFT)		//Sets the ADC acquisition time to 1136 us
