...
#define pwr_clk_mgmt_was_prev_reset_pwr_up()					(pwr_clk_mgmt_get_reset_reason() & PWR_CLK_MGMT_RESET_REASON_PWR_UP ? true : false)		//True if a prior reset was due to power up, false otherwise
#define pwr_clk_mgmt_was_prev_reset_rst_pin()					(pwr_clk_mgmt_get_reset_reason() & PWR_CLK_MGMT_RESET_REASON_RST_PIN ? true : false)	//True if a prior reset was due to the reset pin, false otherwise
#define pwr_clk_mgmt_was_prev_reset_watchdog()					(pwr_clk_mgmt_get_reset_reason() & PWR_CLK_MGMT_RESET_REASON_WATCHDOG ? true : false)	//True if a prior reset was due to watchdog timeout, false otherwise
#define pwr_clk_mgmt_was_prev_reset_debugger()					(pwr_clk_mgmt_get_reset_reason() & PWR_CLK_MGMT_RESET_REASON_DEBUGGER ? true : false)	//True if a prior reset was due to the debugger, false otherwise
