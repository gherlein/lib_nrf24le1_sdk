...
;------------------------------------------------------------
;seconds                   Allocated with name '_delay_s_seconds_1_1'
;count                     Allocated with name '_delay_s_count_1_1'
;------------------------------------------------------------
;	src/delay_s.c:46: void delay_s(uint16_t seconds)
;	-----------------------------------------
;	 function delay_s
;	-----------------------------------------
_delay_s:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay_s_seconds_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
;	src/delay_s.c:51: for(count = 0; count < seconds; count++)
	mov	dptr,#_delay_s_seconds_1_1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00101$:
	...
	subb	a,r7
	jnc	00105$
;	src/delay_s.c:53: delay_ms(1000);
	mov	dptr,#0x03E8
	push	ar7
	push	ar6
	push	ar5
