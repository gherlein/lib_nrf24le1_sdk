...
;--------------------------------------------------------
	.module uart_wait_for_rx_and_get
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'uart_wait_for_rx_and_get'
;------------------------------------------------------------
;	src/uart_wait_for_rx_and_get.c:47: uint8_t uart_wait_for_rx_and_get()
;	-----------------------------------------
;	 function uart_wait_for_rx_and_get
;	-----------------------------------------
_uart_wait_for_rx_and_get:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/uart_wait_for_rx_and_get.c:49: while(!uart_rx_data_ready());
00101$:
;	src/uart_wait_for_rx_and_get.c:51: interrupt_clear_uart_rx();
	jbc	_S0CON_SB_RI0,00108$
	sjmp	00101$
00108$:
;	src/uart_wait_for_rx_and_get.c:53: return uart_get();
	mov	dpl,_S0BUF
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
