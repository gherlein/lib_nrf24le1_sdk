...
; This file was generated Sat Feb 18 15:31:42 2012
;--------------------------------------------------------
	.module watchdog_cause_software_reset
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _watchdog_cause_software_reset
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'watchdog_cause_software_reset'
;------------------------------------------------------------
;	src/watchdog_cause_software_reset.c:47: void watchdog_cause_software_reset()
;	-----------------------------------------
;	 function watchdog_cause_software_reset
;	-----------------------------------------
_watchdog_cause_software_reset:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/watchdog_cause_software_reset.c:50: interrupt_control_global_disable();
	 clr _IEN0_SB_GLOBAL 
;	src/watchdog_cause_software_reset.c:52: watchdog_set_wdsv_count(2);
	mov	dptr,#0x0002
	lcall	_watchdog_set_wdsv_count
;	src/watchdog_cause_software_reset.c:53: while(1);
00102$:
	sjmp	00102$
	.area CSEG    (CODE)
	.area CONST   (CODE)
