...
; This file was generated Mon Mar 26 13:48:13 2012
;--------------------------------------------------------
	.module rf_set_tx_addr
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_set_tx_addr_PARM_2:
	.ds 2
_rf_set_tx_addr_address_1_1:
	.ds 3
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_set_tx_addr'
;------------------------------------------------------------
;len                       Allocated with name '_rf_set_tx_addr_PARM_2'
;address                   Allocated with name '_rf_set_tx_addr_address_1_1'
;------------------------------------------------------------
;	src/rf_set_tx_addr.c:48: void rf_set_tx_addr(uint8_t * address, uint16_t len)
;	-----------------------------------------
;	 function rf_set_tx_addr
;	-----------------------------------------
_rf_set_tx_addr:
	ar7 = 0x07
	ar6 = 0x06
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_set_tx_addr_address_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	movx	@dptr,a
	...
	mov	a,r7
	movx	@dptr,a
;	src/rf_set_tx_addr.c:50: rf_write_register(RF_TX_ADDR, address, len); //Write the requested TX address
	mov	dptr,#_rf_set_tx_addr_address_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
