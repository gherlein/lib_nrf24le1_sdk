...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_rx_fifo_is_full_fifo_status_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_rx_fifo_is_full'
;------------------------------------------------------------
;fifo_status               Allocated with name '_rf_rx_fifo_is_full_fifo_status_1_1'
;------------------------------------------------------------
;	src/rf_rx_fifo_is_full.c:47: bool rf_rx_fifo_is_full()
;	-----------------------------------------
;	 function rf_rx_fifo_is_full
;	-----------------------------------------
_rf_rx_fifo_is_full:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/rf_rx_fifo_is_full.c:51: rf_read_register(RF_FIFO_STATUS, &fifo_status, 1);
	mov	dptr,#_rf_read_register_PARM_2
	mov	a,#_rf_rx_fifo_is_full_fifo_status_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,#(_rf_rx_fifo_is_full_fifo_status_1_1 >> 8)
	movx	@dptr,a
	inc	dptr
	clr	a
	movx	@dptr,a
...
;	src/rf_rx_fifo_is_full.c:53: return (fifo_status & RF_FIFO_STATUS_RX_FULL) ? true : false;
	mov	dptr,#_rf_rx_fifo_is_full_fifo_status_1_1
	movx	a,@dptr
	mov	r7,a
	jnb	acc.1,00103$
	mov	r7,#0x01
