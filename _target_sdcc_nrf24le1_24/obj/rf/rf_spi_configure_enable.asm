...
; This file was generated Mon Mar 26 13:48:14 2012
;--------------------------------------------------------
	.module rf_spi_configure_enable
...
;------------------------------------------------------------
;------------------------------------------------------------
;	src/rf_spi_configure_enable.c:47: void rf_spi_configure_enable()
;	-----------------------------------------
...
_rf_spi_configure_enable:
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/rf_spi_configure_enable.c:50: RFCON = 0x02;
	mov	_RFCON,#0x02
;	src/rf_spi_configure_enable.c:51: RFCON = RFCON_RFCKEN;
	mov	_RFCON,#0x04
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
