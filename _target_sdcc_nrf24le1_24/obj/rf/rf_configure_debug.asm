...
; This file was generated Tue Jun 19 17:33:11 2012
;--------------------------------------------------------
	.module rf_configure_debug
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _rf_configure_debug_PARM_3
	.globl _rf_configure_debug_PARM_2
	.globl _rf_configure_debug
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_configure_debug_PARM_2:
	.ds 1
_rf_configure_debug_PARM_3:
	.ds 1
_rf_configure_debug_rx_1_1:
	.ds 1
_rf_configure_debug_config_1_1:
	.ds 1
_rf_configure_debug_en_aa_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_configure_debug'
;------------------------------------------------------------
;p0_payload_width          Allocated with name '_rf_configure_debug_PARM_2'
;enable_auto_ack           Allocated with name '_rf_configure_debug_PARM_3'
;rx                        Allocated with name '_rf_configure_debug_rx_1_1'
;config                    Allocated with name '_rf_configure_debug_config_1_1'
;en_aa                     Allocated with name '_rf_configure_debug_en_aa_1_1'
;------------------------------------------------------------
;	src/rf_configure_debug.c:49: void rf_configure_debug(bool rx, uint8_t p0_payload_width, bool enable_auto_ack)
;	-----------------------------------------
;	 function rf_configure_debug
;	-----------------------------------------
_rf_configure_debug:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar1 = 0x01
	mov	a,dpl
	mov	dptr,#_rf_configure_debug_rx_1_1
	movx	@dptr,a
;	src/rf_configure_debug.c:54: config = RF_CONFIG_DEFAULT_VAL | RF_CONFIG_PWR_UP; //Set config to the default value of CONFIG with the PWR_UP bit set
	mov	dptr,#_rf_configure_debug_config_1_1
	mov	a,#0x0A
	movx	@dptr,a
;	src/rf_configure_debug.c:57: if(enable_auto_ack != false)
	mov	dptr,#_rf_configure_debug_PARM_3
	movx	a,@dptr
	mov	r2,a
	jz	00102$
;	src/rf_configure_debug.c:59: en_aa = RF_EN_AA_ENAA_P0;
	mov	dptr,#_rf_configure_debug_en_aa_1_1
	mov	a,#0x01
	movx	@dptr,a
	sjmp	00103$
00102$:
;	src/rf_configure_debug.c:63: en_aa = RF_EN_AA_ENAA_NONE;
	mov	dptr,#_rf_configure_debug_en_aa_1_1
	clr	a
	movx	@dptr,a
00103$:
;	src/rf_configure_debug.c:67: if(rx == true)
	mov	dptr,#_rf_configure_debug_rx_1_1
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x01,00105$
;	src/rf_configure_debug.c:69: config = config | RF_CONFIG_PRIM_RX;
	mov	dptr,#_rf_configure_debug_config_1_1
	mov	a,#0x0B
	movx	@dptr,a
00105$:
;	src/rf_configure_debug.c:73: rf_configure(config,
	mov	dptr,#_rf_configure_debug_config_1_1
	movx	a,@dptr
	mov	r2,a
;	src/rf_configure_debug.c:75: en_aa,
	mov	dptr,#_rf_configure_debug_en_aa_1_1
	movx	a,@dptr
	mov	r3,a
;	src/rf_configure_debug.c:88: p0_payload_width,
	mov	dptr,#_rf_configure_debug_PARM_2
	movx	a,@dptr
	mov	r4,a
;	src/rf_configure_debug.c:95: RF_FEATURE_NONE);
