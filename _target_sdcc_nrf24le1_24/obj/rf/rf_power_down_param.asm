...
; This file was generated Mon Mar 26 13:48:08 2012
;--------------------------------------------------------
	.module rf_power_down_param
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_power_down_param_config_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_power_down_param'
;------------------------------------------------------------
;config                    Allocated with name '_rf_power_down_param_config_1_1'
;------------------------------------------------------------
;	src/rf_power_down_param.c:47: void rf_power_down_param(uint8_t config)
;	-----------------------------------------
;	 function rf_power_down_param
;	-----------------------------------------
_rf_power_down_param:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_power_down_param_config_1_1
	movx	@dptr,a
;	src/rf_power_down_param.c:49: rf_clear_ce(); //Ensure the CE pin is cleared
	 clr _RFCON_SB_RFCE 
;	src/rf_power_down_param.c:51: config &= (~RF_CONFIG_PWR_UP); //Use the passed in value of CONFIG and ensure the PWR_UP bit is cleared, then write the register
	mov	dptr,#_rf_power_down_param_config_1_1
	movx	a,@dptr
	anl	a,#0xFD
	movx	@dptr,a
;	src/rf_power_down_param.c:52: rf_write_register(RF_CONFIG, &config, 1);
	mov	dptr,#_rf_write_register_PARM_2
	mov	a,#_rf_power_down_param_config_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,#(_rf_power_down_param_config_1_1 >> 8)
	movx	@dptr,a
	inc	dptr
	clr	a
	movx	@dptr,a
