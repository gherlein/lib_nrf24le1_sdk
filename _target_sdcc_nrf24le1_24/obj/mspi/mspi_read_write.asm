...
; This file was generated Sat Jun 23 17:46:43 2012
;--------------------------------------------------------
	.module mspi_read_write
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'mspi_read_write'
;------------------------------------------------------------
;mspi_data                 Allocated to registers r2 
;------------------------------------------------------------
;	src/mspi_read_write.c:47: uint8_t mspi_read_write(uint8_t mspi_data) __reentrant
;	-----------------------------------------
;	 function mspi_read_write
;	-----------------------------------------
_mspi_read_write:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar1 = 0x01
	mov	r2,dpl
;	src/mspi_read_write.c:50: while(mspi_is_rx_data_ready())
00101$:
	mov	a,_SPIMSTAT
	jnb	acc.2,00103$
;	src/mspi_read_write.c:52: mspi_get();
	mov	a,_SPIMDAT
	sjmp	00101$
00103$:
;	src/mspi_read_write.c:56: mspi_send(mspi_data);
	mov	_SPIMDAT,r2
;	src/mspi_read_write.c:59: while(!mspi_is_rx_data_ready());
00104$:
	mov	a,_SPIMSTAT
	jnb	acc.2,00104$
;	src/mspi_read_write.c:62: return mspi_get();
	mov	dpl,_SPIMDAT
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
