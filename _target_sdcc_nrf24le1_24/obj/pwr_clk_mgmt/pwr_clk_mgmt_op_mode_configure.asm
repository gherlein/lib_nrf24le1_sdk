...
;--------------------------------------------------------
	.module pwr_clk_mgmt_op_mode_configure
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_op_mode_configure_op_mode_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'pwr_clk_mgmt_op_mode_configure'
;------------------------------------------------------------
;op_mode_config_options    Allocated with name '_pwr_clk_mgmt_op_mode_configure_op_mode_config_options_1_1'
;------------------------------------------------------------
;	src/pwr_clk_mgmt_op_mode_configure.c:52: void pwr_clk_mgmt_op_mode_configure(uint8_t op_mode_config_options)
;	-----------------------------------------
;	 function pwr_clk_mgmt_op_mode_configure
;	-----------------------------------------
_pwr_clk_mgmt_op_mode_configure:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_pwr_clk_mgmt_op_mode_configure_op_mode_config_options_1_1
	movx	@dptr,a
;	src/pwr_clk_mgmt_op_mode_configure.c:55: OPMCON = (OPMCON & ~PWR_CLK_MGMT_OP_MODE_CONFIG_OPTION_OPMCON_MASK) | (op_mode_config_options & PWR_CLK_MGMT_OP_MODE_CONFIG_OPTION_OPMCON_MASK);
	mov	r7,_OPMCON
	anl	ar7,#0xF8
	mov	dptr,#_pwr_clk_mgmt_op_mode_configure_op_mode_config_options_1_1
	movx	a,@dptr
