...
; This file was generated Fri Mar 23 15:39:00 2012
;--------------------------------------------------------
	.module pwr_clk_mgmt_wakeup_pins_configure
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_wakeup_pins_configure_wakeup_on_pin_config_options_1_1:
	.ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'pwr_clk_mgmt_wakeup_pins_configure'
;------------------------------------------------------------
;wakeup_on_pin_config_options Allocated with name '_pwr_clk_mgmt_wakeup_pins_configure_wakeup_on_pin_config_options_1_1'
;------------------------------------------------------------
;	src/pwr_clk_mgmt_wakeup_pins_configure.c:47: void pwr_clk_mgmt_wakeup_pins_configure(uint16_t wakeup_on_pin_config_options)
;	-----------------------------------------
;	 function pwr_clk_mgmt_wakeup_pins_configure
;	-----------------------------------------
_pwr_clk_mgmt_wakeup_pins_configure:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_pwr_clk_mgmt_wakeup_pins_configure_wakeup_on_pin_config_options_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
;	src/pwr_clk_mgmt_wakeup_pins_configure.c:50: WUOPC0 = wakeup_on_pin_config_options & 0xFF;
	mov	dptr,#_pwr_clk_mgmt_wakeup_pins_configure_wakeup_on_pin_config_options_1_1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	mov	ar4,r6
	mov	_WUOPC0,r4
;	src/pwr_clk_mgmt_wakeup_pins_configure.c:51: WUOPC1 = (wakeup_on_pin_config_options >> 8) & 0xFF;
	mov	ar6,r7
	mov	_WUOPC1,r6
	ret
	.area CSEG    (CODE)
