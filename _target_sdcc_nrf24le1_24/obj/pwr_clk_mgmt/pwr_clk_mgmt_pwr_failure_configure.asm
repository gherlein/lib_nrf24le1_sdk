...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_pwr_failure_configure_pwr_failure_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;pwr_failure_config_options Allocated with name '_pwr_clk_mgmt_pwr_failure_configure_pwr_failure_config_options_1_1'
;------------------------------------------------------------
;	src/pwr_clk_mgmt_pwr_failure_configure.c:52: void pwr_clk_mgmt_pwr_failure_configure(uint8_t pwr_failure_config_options)
;	-----------------------------------------
...
_pwr_clk_mgmt_pwr_failure_configure:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_pwr_clk_mgmt_pwr_failure_configure_pwr_failure_config_options_1_1
	movx	@dptr,a
;	src/pwr_clk_mgmt_pwr_failure_configure.c:55: POFCON = (POFCON & ~PWR_CLK_MGMT_CLKLF_CONFIG_OPTION_POFCON_MASK) | (pwr_failure_config_options & PWR_CLK_MGMT_CLKLF_CONFIG_OPTION_POFCON_MASK);
	mov	r7,_POFCON
	anl	ar7,#0x0F
	mov	dptr,#_pwr_clk_mgmt_pwr_failure_configure_pwr_failure_config_options_1_1
	movx	a,@dptr
