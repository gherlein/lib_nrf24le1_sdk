...
;--------------------------------------------------------
	.module pwr_clk_mgmt_wakeup_sources_configure
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _pwr_clk_mgmt_wakeup_sources_configure
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_wakeup_sources_configure_wakeup_sources_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'pwr_clk_mgmt_wakeup_sources_configure'
;------------------------------------------------------------
;wakeup_sources_config_options Allocated with name '_pwr_clk_mgmt_wakeup_sources_configure_wakeup_sources_config_options_1_1'
;------------------------------------------------------------
;	src/pwr_clk_mgmt_wakeup_sources_configure.c:46: void pwr_clk_mgmt_wakeup_sources_configure(uint8_t wakeup_sources_config_options)
;	-----------------------------------------
;	 function pwr_clk_mgmt_wakeup_sources_configure
;	-----------------------------------------
_pwr_clk_mgmt_wakeup_sources_configure:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
;	src/pwr_clk_mgmt_wakeup_sources_configure.c:49: WUCON = wakeup_sources_config_options;
	mov	dptr,#_pwr_clk_mgmt_wakeup_sources_configure_wakeup_sources_config_options_1_1
	movx	@dptr,a
	mov	_WUCON,a
	ret
	.area CSEG    (CODE)
