...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwm_configure_pwm_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;pwm_config_options        Allocated with name '_pwm_configure_pwm_config_options_1_1'
;------------------------------------------------------------
;	src/pwm_configure.c:52: void pwm_configure(uint8_t pwm_config_options)
;	-----------------------------------------
...
_pwm_configure:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_pwm_configure_pwm_config_options_1_1
	movx	@dptr,a
;	src/pwm_configure.c:55: PWMCON = (PWMCON & ~PWM_CONFIG_OPTION_PWMCON_MASK) | (pwm_config_options & PWM_CONFIG_OPTION_PWMCON_MASK);
	mov	r7,_PWMCON
	anl	ar7,#0x03
	mov	dptr,#_pwm_configure_pwm_config_options_1_1
	movx	a,@dptr
