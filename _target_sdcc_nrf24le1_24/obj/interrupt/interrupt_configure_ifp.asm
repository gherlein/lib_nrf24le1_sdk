...
; This file was generated Tue Jun 19 17:33:09 2012
;--------------------------------------------------------
	.module interrupt_configure_ifp
...
_interrupt_configure_ifp_PARM_2:
	.ds 1
_interrupt_configure_ifp_interrupt_ifp_input_1_1:
	.ds 1
;--------------------------------------------------------
...
;interrupt_ifp_input       Allocated with name '_interrupt_configure_ifp_interrupt_ifp_input_1_1'
;------------------------------------------------------------
;	src/interrupt_configure_ifp.c:57: bool interrupt_configure_ifp(interrupt_ifp_input_t interrupt_ifp_input, uint8_t ifp_int_config_options)
;	-----------------------------------------
...
_interrupt_configure_ifp:
	...
	ar1 = 0x01
	mov	a,dpl
	mov	dptr,#_interrupt_configure_ifp_interrupt_ifp_input_1_1
	movx	@dptr,a
;	src/interrupt_configure_ifp.c:60: if(ifp_int_config_options & INTERRUPT_IFP_CONFIG_OPTION_ENABLE)
	mov	dptr,#_interrupt_configure_ifp_PARM_2
	movx	a,@dptr
	mov	r2,a
	jnb	acc.7,00116$
;	src/interrupt_configure_ifp.c:63: if(interrupt_ifp_input == INTERRUPT_IFP_INPUT_GPINT0)
	mov	dptr,#_interrupt_configure_ifp_interrupt_ifp_input_1_1
	movx	a,@dptr
	mov	r3,a
	cjne	r3,#0x08,00108$
;	src/interrupt_configure_ifp.c:65: INTEXP = (INTEXP & ~INTERRUPT_IFP_CONFIG_INTEXP_GPINTX_MASK) | INTERRUPT_IFP_INPUT_GPINT0;
	mov	r4,_INTEXP
	mov	a,#0xC7
	anl	a,r4
	mov	b,a
	...
	sjmp	00109$
00108$:
;	src/interrupt_configure_ifp.c:67: else if(interrupt_ifp_input == INTERRUPT_IFP_INPUT_GPINT1)
	cjne	r3,#0x10,00105$
;	src/interrupt_configure_ifp.c:69: INTEXP = (INTEXP & ~INTERRUPT_IFP_CONFIG_INTEXP_GPINTX_MASK) | INTERRUPT_IFP_INPUT_GPINT1;
	mov	r4,_INTEXP
	mov	a,#0xC7
	anl	a,r4
	mov	b,a
	...
	sjmp	00109$
00105$:
;	src/interrupt_configure_ifp.c:71: else if(interrupt_ifp_input == INTERRUPT_IFP_INPUT_GPINT2)
	cjne	r3,#0x20,00102$
;	src/interrupt_configure_ifp.c:73: INTEXP = (INTEXP & ~INTERRUPT_IFP_CONFIG_INTEXP_GPINTX_MASK) | INTERRUPT_IFP_INPUT_GPINT2;
	mov	r3,_INTEXP
	mov	a,#0xC7
	anl	a,r3
	mov	b,a
	...
	sjmp	00109$
00102$:
;	src/interrupt_configure_ifp.c:78: return false;
	mov	dpl,#0x00
	ret
00109$:
;	src/interrupt_configure_ifp.c:82: TCON = (TCON & ~INTERRUPT_IFP_CONFIG_TCON_MASK) | (ifp_int_config_options & INTERRUPT_IFP_CONFIG_TCON_MASK);
	mov	r3,_TCON
	anl	ar3,#0xFE
	mov	a,#0x01
	anl	a,r2
	...
	sjmp	00117$
00116$:
;	src/interrupt_configure_ifp.c:87: if((interrupt_ifp_input == INTERRUPT_IFP_INPUT_GPINT0) || (interrupt_ifp_input == INTERRUPT_IFP_INPUT_GPINT1) || (interrupt_ifp_input == INTERRUPT_IFP_INPUT_GPINT2))
	mov	dptr,#_interrupt_configure_ifp_interrupt_ifp_input_1_1
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x08,00133$
...
00134$:
	cjne	r2,#0x20,00111$
00110$:
;	src/interrupt_configure_ifp.c:89: INTEXP = (INTEXP & ~INTERRUPT_IFP_CONFIG_INTEXP_GPINTX_MASK);
	anl	_INTEXP,#0xC7
	sjmp	00117$
00111$:
;	src/interrupt_configure_ifp.c:94: return false;
	mov	dpl,#0x00
;	src/interrupt_configure_ifp.c:98: return true;
	ret
00117$:
	mov	dpl,#0x01
	ret
