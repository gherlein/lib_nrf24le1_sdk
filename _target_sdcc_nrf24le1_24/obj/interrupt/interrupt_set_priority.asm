...
; This file was generated Sat Feb 18 15:30:52 2012
;--------------------------------------------------------
	.module interrupt_set_priority
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _interrupt_set_priority_PARM_2
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_interrupt_set_priority_PARM_2:
	.ds 1
_interrupt_set_priority_interrupt_priority_group_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;interrupt_priority_level  Allocated with name '_interrupt_set_priority_PARM_2'
;interrupt_priority_group  Allocated with name '_interrupt_set_priority_interrupt_priority_group_1_1'
;------------------------------------------------------------
;	src/interrupt_set_priority.c:53: void interrupt_set_priority(interrupt_priority_group_t interrupt_priority_group, interrupt_priority_level_t interrupt_priority_level)
;	-----------------------------------------
...
_interrupt_set_priority:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/interrupt_set_priority.c:56: if((interrupt_priority_group >= INTERRUPT_PRIORITY_GROUP_NUM) || (interrupt_priority_level >= INTERRUPT_PRIORITY_LEVEL_NUM))
	mov	dptr,#_interrupt_set_priority_interrupt_priority_group_1_1
	movx	@dptr,a
	mov	r7,a
	cjne	r7,#0x06,00115$
00115$:
	jnc	00101$
	mov	dptr,#_interrupt_set_priority_PARM_2
	movx	a,@dptr
	mov	r6,a
	cjne	r6,#0x04,00117$
00117$:
	jc	00102$
00101$:
;	src/interrupt_set_priority.c:58: return;
	ret
00102$:
;	src/interrupt_set_priority.c:65: if(interrupt_priority_level & INTERRUPT_IP0_MASK)
	mov	a,r6
	jnb	acc.0,00105$
;	src/interrupt_set_priority.c:67: IP0 |= (1 << interrupt_priority_group);
	mov	b,r7
	inc	b
	mov	a,#0x01
	sjmp	00122$
...
00122$:
	...
	sjmp	00106$
00105$:
;	src/interrupt_set_priority.c:71: IP0 &= (~(1 << interrupt_priority_group));
	mov	b,r7
	inc	b
	mov	a,#0x01
	sjmp	00125$
...
00125$:
	...
	anl	_IP0,a
00106$:
;	src/interrupt_set_priority.c:74: if(interrupt_priority_level & INTERRUPT_IP1_MASK)
	mov	a,r6
	jnb	acc.1,00108$
;	src/interrupt_set_priority.c:76: IP1 |= (1 << interrupt_priority_group);
	mov	b,r7
	inc	b
	mov	a,#0x01
	sjmp	00129$
...
00129$:
	...
	ret
00108$:
;	src/interrupt_set_priority.c:80: IP1 &= (~(1 << interrupt_priority_group));
	mov	b,r7
	inc	b
	mov	a,#0x01
	sjmp	00132$
