...
; This file was generated Sat Feb 18 15:31:21 2012
;--------------------------------------------------------
	.module rng_get_one_byte_and_turn_off
	.optsdcc -mmcs51 --model-large
	
;--------------------------------------------------------
; Public variables in this module
;--------------------------------------------------------
	.globl _rng_get_next_byte
	.globl _rng_configure
	.globl _FSR_SB_ENDBG
	.globl _FSR_SB_STP
	.globl _FSR_SB_WEN
	.globl _FSR_SB_RDYN
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rng_get_one_byte_and_turn_off'
;------------------------------------------------------------
;rand_val                  Allocated with name '_rng_get_one_byte_and_turn_off_rand_val_1_1'
;------------------------------------------------------------
;	src/rng_get_one_byte_and_turn_off.c:47: uint8_t rng_get_one_byte_and_turn_off()
;	-----------------------------------------
;	 function rng_get_one_byte_and_turn_off
;	-----------------------------------------
_rng_get_one_byte_and_turn_off:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/rng_get_one_byte_and_turn_off.c:51: rng_configure(RNG_CONFIG_OPTION_RUN | RNG_CONFIG_CORRECTOR_ENABLE);
	mov	dpl,#0xC0
	lcall	_rng_configure
;	src/rng_get_one_byte_and_turn_off.c:52: rand_val = rng_get_next_byte();
	lcall	_rng_get_next_byte
	mov	r7,dpl
;	src/rng_get_one_byte_and_turn_off.c:53: rng_stop();
	mov	r6,_RNGCTL
	anl	ar6,#0x7F
	mov	_RNGCTL,r6
;	src/rng_get_one_byte_and_turn_off.c:55: return rand_val;
	mov	dpl,r7
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
