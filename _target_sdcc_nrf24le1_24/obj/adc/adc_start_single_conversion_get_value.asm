...
;--------------------------------------------------------
	.module adc_start_single_conversion_get_value
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_adc_start_single_conversion_get_value_adc_channel_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;adc_channel               Allocated with name '_adc_start_single_conversion_get_value_adc_channel_1_1'
;------------------------------------------------------------
;	src/adc_start_single_conversion_get_value.c:48: uint16_t adc_start_single_conversion_get_value(adc_channel_t adc_channel)
;	-----------------------------------------
...
_adc_start_single_conversion_get_value:
	...
	ar1 = 0x01
	mov	a,dpl
	mov	dptr,#_adc_start_single_conversion_get_value_adc_channel_1_1
	movx	@dptr,a
;	src/adc_start_single_conversion_get_value.c:50: adc_start_single_conversion(adc_channel);
	mov	dptr,#_adc_start_single_conversion_get_value_adc_channel_1_1
	movx	a,@dptr
	mov	dpl,a
	lcall	_adc_start_single_conversion
;	src/adc_start_single_conversion_get_value.c:52: while(adc_is_conversion_in_progress());
00101$:
	mov	a,#0x40
	anl	a,_ADCCON1
	mov	r2,a
	...
	sjmp	00101$
00108$:
;	src/adc_start_single_conversion_get_value.c:54: return adc_get_result();
	mov	dpl,_ADCDAT
	mov	dph,(_ADCDAT >> 8)
	ret
	.area CSEG    (CODE)
