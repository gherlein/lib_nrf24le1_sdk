...
;--------------------------------------------------------
	.module memory_flash_copy_page_to_ram
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _memory_flash_copy_page_to_ram_PARM_2
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_memory_flash_copy_page_to_ram_PARM_2:
	.ds 3
_memory_flash_copy_page_to_ram_page_num_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'memory_flash_copy_page_to_ram'
;------------------------------------------------------------
;page_buffer               Allocated with name '_memory_flash_copy_page_to_ram_PARM_2'
;page_num                  Allocated with name '_memory_flash_copy_page_to_ram_page_num_1_1'
;------------------------------------------------------------
;	src/memory_flash_copy_page_to_ram.c:47: memory_flash_return_t memory_flash_copy_page_to_ram(uint8_t page_num, uint8_t * page_buffer)
;	-----------------------------------------
;	 function memory_flash_copy_page_to_ram
;	-----------------------------------------
_memory_flash_copy_page_to_ram:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
;	src/memory_flash_copy_page_to_ram.c:50: if(page_num >= MEMORY_FLASH_NUM_PAGES)
	mov	dptr,#_memory_flash_copy_page_to_ram_page_num_1_1
	movx	@dptr,a
	mov	r7,a
	cjne	r7,#0x24,00109$
00109$:
	jc	00102$
;	src/memory_flash_copy_page_to_ram.c:52: return MEMORY_FLASH_BAD_PARAMS;
	mov	dpl,#0x01
	ret
00102$:
;	src/memory_flash_copy_page_to_ram.c:56: if(memory_flash_read_bytes(memory_flash_get_page_start_address(page_num), MEMORY_FLASH_PAGE_SIZE, page_buffer) != MEMORY_FLASH_OK)
	mov	a,r7
	add	a,r7
	mov	r6,a
	mov	r7,#0x00
	...
	mov	dpl,r7
	mov	dph,r6
	lcall	_memory_flash_read_bytes
	mov	a,dpl
	jz	00104$
;	src/memory_flash_copy_page_to_ram.c:58: return MEMORY_FLASH_BAD_PARAMS;
	mov	dpl,#0x01
	ret
00104$:
;	src/memory_flash_copy_page_to_ram.c:61: return MEMORY_FLASH_OK;
	mov	dpl,#0x00
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
