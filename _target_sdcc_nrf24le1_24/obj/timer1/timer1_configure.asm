...
; This file was generated Sat Feb 18 15:31:24 2012
;--------------------------------------------------------
	.module timer1_configure
...
_timer1_configure_PARM_2:
	.ds 2
_timer1_configure_timer1_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;timer1_config_options     Allocated with name '_timer1_configure_timer1_config_options_1_1'
;------------------------------------------------------------
;	src/timer1_configure.c:53: void timer1_configure(uint8_t timer1_config_options, uint16_t t1_val)
;	-----------------------------------------
...
_timer1_configure:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/timer1_configure.c:56: if((timer1_config_options & TMOD_MODE1_MASK) == TIMER1_CONFIG_OPTION_MODE_2_8_BIT_AUTO_RLD_TMR)
	mov	dptr,#_timer1_configure_timer1_config_options_1_1
	movx	@dptr,a
	mov	r7,a
	mov	a,#0x30
	anl	a,r7
	mov	r6,a
	cjne	r6,#0x20,00102$
;	src/timer1_configure.c:58: TH1 = (uint8_t)t1_val;
	...
	mov	r6,a
	mov	_TH1,r5
;	src/timer1_configure.c:59: TL1 = (uint8_t)t1_val;
	mov	_TL1,r5
	sjmp	00103$
00102$:
;	src/timer1_configure.c:63: timer1_set_t1_val(t1_val);
	mov	dptr,#_timer1_configure_PARM_2
	movx	a,@dptr
	mov	_T1,a
	inc	dptr
	...
	mov	(_T1 >> 8),a
00103$:
;	src/timer1_configure.c:67: TMOD = (TMOD & ~TIMER1_CONFIG_OPTION_TMOD_MASK) | (timer1_config_options & TIMER1_CONFIG_OPTION_TMOD_MASK);
	mov	r6,_TMOD
	anl	ar6,#0x0F
	anl	ar7,#0xF0
	mov	a,r7
