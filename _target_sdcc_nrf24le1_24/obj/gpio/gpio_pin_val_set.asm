...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_gpio_pin_val_set_gpio_pin_id_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;gpio_pin_id               Allocated with name '_gpio_pin_val_set_gpio_pin_id_1_1'
;------------------------------------------------------------
;	src/gpio_pin_val_set.c:46: void gpio_pin_val_set(gpio_pin_id_t gpio_pin_id)
;	-----------------------------------------
...
_gpio_pin_val_set:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/gpio_pin_val_set.c:49: if(gpio_pin_id <= GPIO_PIN_ID_P0_7)
	mov	dptr,#_gpio_pin_val_set_gpio_pin_id_1_1
	movx	@dptr,a
	mov  r7,a
	add	a,#0xff - 0x07
	jc	00110$
;	src/gpio_pin_val_set.c:51: gpio_pins_val_set(P0, (1 << (gpio_pin_id % 8)));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00121$:
	...
	ret
00110$:
;	src/gpio_pin_val_set.c:53: else if(gpio_pin_id <= GPIO_PIN_ID_P1_7)
	mov	a,r7
	add	a,#0xff - 0x0F
	jc	00107$
;	src/gpio_pin_val_set.c:55: gpio_pins_val_set(P1, (1 << (gpio_pin_id % 8)));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00125$:
	...
	ret
00107$:
;	src/gpio_pin_val_set.c:57: else if(gpio_pin_id <= GPIO_PIN_ID_P2_7)
	mov	a,r7
	add	a,#0xff - 0x17
	jc	00104$
;	src/gpio_pin_val_set.c:59: gpio_pins_val_set(P2, (1 << (gpio_pin_id % 8)));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00129$:
	...
	ret
00104$:
;	src/gpio_pin_val_set.c:61: else if(gpio_pin_id <= GPIO_PIN_ID_P3_6)
	mov	a,r7
	add	a,#0xff - 0x1E
	jc	00112$
;	src/gpio_pin_val_set.c:63: gpio_pins_val_set(P3, (1 << (gpio_pin_id % 8)));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
