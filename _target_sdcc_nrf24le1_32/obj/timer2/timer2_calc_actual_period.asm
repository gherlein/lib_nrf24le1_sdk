...
;--------------------------------------------------------
	.module timer2_calc_actual_period
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _timer2_calc_actual_period_PARM_2
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_timer2_calc_actual_period_PARM_2:
	.ds 1
_timer2_calc_actual_period_crc_val_1_1:
	.ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'timer2_calc_actual_period'
;------------------------------------------------------------
;t2ps_bit_val              Allocated with name '_timer2_calc_actual_period_PARM_2'
;crc_val                   Allocated with name '_timer2_calc_actual_period_crc_val_1_1'
;------------------------------------------------------------
;	src/timer2_calc_actual_period.c:48: float timer2_calc_actual_period(uint16_t crc_val, bool t2ps_bit_val)
;	-----------------------------------------
;	 function timer2_calc_actual_period
;	-----------------------------------------
_timer2_calc_actual_period:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_timer2_calc_actual_period_crc_val_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
;	src/timer2_calc_actual_period.c:55: return (((((float)65536 - (float)crc_val)) * ((float)(((t2ps_bit_val ? 2 : 1) * 12)))) / ((float)pwr_clk_mgmt_get_cclk_freq_in_hz()));
	mov	dptr,#_timer2_calc_actual_period_crc_val_1_1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
