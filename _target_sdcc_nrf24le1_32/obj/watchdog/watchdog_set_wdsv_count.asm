...
;--------------------------------------------------------
	.module watchdog_set_wdsv_count
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_watchdog_set_wdsv_count_wdsv_value_1_1:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;wdsv_value                Allocated with name '_watchdog_set_wdsv_count_wdsv_value_1_1'
;------------------------------------------------------------
;	src/watchdog_set_wdsv_count.c:46: void watchdog_set_wdsv_count(uint16_t wdsv_value)
;	-----------------------------------------
...
_watchdog_set_wdsv_count:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_watchdog_set_wdsv_count_wdsv_value_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
;	src/watchdog_set_wdsv_count.c:49: WDSV = (uint8_t)wdsv_value;
	mov	dptr,#_watchdog_set_wdsv_count_wdsv_value_1_1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	mov	r7,a
	mov	_WDSV,r6
;	src/watchdog_set_wdsv_count.c:50: WDSV = (uint8_t)(wdsv_value >> 8);
	mov	_WDSV,r7
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
