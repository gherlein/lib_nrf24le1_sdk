...
;--------------------------------------------------------
	.module watchdog_get_wdsv_count
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _watchdog_get_wdsv_count
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'watchdog_get_wdsv_count'
;------------------------------------------------------------
;wdsv_value                Allocated with name '_watchdog_get_wdsv_count_wdsv_value_1_1'
;------------------------------------------------------------
;	src/watchdog_get_wdsv_count.c:45: uint16_t watchdog_get_wdsv_count()
;	-----------------------------------------
;	 function watchdog_get_wdsv_count
;	-----------------------------------------
_watchdog_get_wdsv_count:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/watchdog_get_wdsv_count.c:50: wdsv_value = WDSV;
	mov	r6,_WDSV
	mov	r7,#0x00
;	src/watchdog_get_wdsv_count.c:51: wdsv_value += (WDSV << 8);
	mov	r4,_WDSV
	mov	ar5,r4
	clr	a
	add	a,r6
	...
	mov	a,r5
	addc	a,r7
;	src/watchdog_get_wdsv_count.c:53: return wdsv_value;
	mov	dpl,r6
	mov	dph,a
	ret
	.area CSEG    (CODE)
