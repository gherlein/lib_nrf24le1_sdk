...
_gpio_pin_val_write_PARM_2:
	.ds 1
_gpio_pin_val_write_gpio_pin_id_1_1:
	.ds 1
;--------------------------------------------------------
...
;gpio_pin_id               Allocated with name '_gpio_pin_val_write_gpio_pin_id_1_1'
;------------------------------------------------------------
;	src/gpio_pin_val_write.c:47: void gpio_pin_val_write(gpio_pin_id_t gpio_pin_id, bool value)
;	-----------------------------------------
...
_gpio_pin_val_write:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_gpio_pin_val_write_gpio_pin_id_1_1
	movx	@dptr,a
;	src/gpio_pin_val_write.c:50: if(value)
	mov	dptr,#_gpio_pin_val_write_PARM_2
	movx	a,@dptr
	mov	r7,a
	jz	00102$
;	src/gpio_pin_val_write.c:52: gpio_pin_val_set(gpio_pin_id);
	mov	dptr,#_gpio_pin_val_write_gpio_pin_id_1_1
	movx	a,@dptr
	mov	dpl,a
	ljmp	_gpio_pin_val_set
00102$:
;	src/gpio_pin_val_write.c:56: gpio_pin_val_clear(gpio_pin_id);
	mov	dptr,#_gpio_pin_val_write_gpio_pin_id_1_1
	movx	a,@dptr
	mov	dpl,a
