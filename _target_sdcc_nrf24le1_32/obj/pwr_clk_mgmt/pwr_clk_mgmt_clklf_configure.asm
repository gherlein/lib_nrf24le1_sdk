...
;--------------------------------------------------------
	.module pwr_clk_mgmt_clklf_configure
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_clklf_configure_clklf_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;clklf_config_options      Allocated with name '_pwr_clk_mgmt_clklf_configure_clklf_config_options_1_1'
;------------------------------------------------------------
;	src/pwr_clk_mgmt_clklf_configure.c:52: void pwr_clk_mgmt_clklf_configure(uint8_t clklf_config_options)
;	-----------------------------------------
...
_pwr_clk_mgmt_clklf_configure:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_pwr_clk_mgmt_clklf_configure_clklf_config_options_1_1
	movx	@dptr,a
;	src/pwr_clk_mgmt_clklf_configure.c:55: CLKLFCTRL = (CLKLFCTRL & ~PWR_CLK_MGMT_CLKLF_CONFIG_OPTION_CLKLFCTRL_MASK) | (clklf_config_options & PWR_CLK_MGMT_CLKLF_CONFIG_OPTION_CLKLFCTRL_MASK);
	mov	r7,_CLKLFCTRL
	anl	ar7,#0xF8
	mov	dptr,#_pwr_clk_mgmt_clklf_configure_clklf_config_options_1_1
	movx	a,@dptr
