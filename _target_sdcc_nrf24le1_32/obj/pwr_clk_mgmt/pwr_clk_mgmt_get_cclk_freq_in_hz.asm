...
;--------------------------------------------------------
	.module pwr_clk_mgmt_get_cclk_freq_in_hz
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_get_cclk_freq_in_hz_cclk_freq_hz_1_1:
	.ds 4
;--------------------------------------------------------
...
;------------------------------------------------------------
;divider                   Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_hz_divider_1_1'
;i                         Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_hz_i_1_1'
;cclk_freq_hz              Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_hz_cclk_freq_hz_1_1'
;------------------------------------------------------------
;	src/pwr_clk_mgmt_get_cclk_freq_in_hz.c:46: uint32_t pwr_clk_mgmt_get_cclk_freq_in_hz()
;	-----------------------------------------
...
_pwr_clk_mgmt_get_cclk_freq_in_hz:
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/pwr_clk_mgmt_get_cclk_freq_in_hz.c:48: uint8_t divider = (CLKCTRL & CLKCTRL_CLK_FREQ_MASK) >> CLKCTRL_CLK_FREQ_SHIFT;
	mov	a,#0x07
	anl	a,_CLKCTRL
	mov	r7,a
;	src/pwr_clk_mgmt_get_cclk_freq_in_hz.c:50: uint32_t cclk_freq_hz = CCLK_MAX_FREQ_HZ;
	mov	dptr,#_pwr_clk_mgmt_get_cclk_freq_in_hz_cclk_freq_hz_1_1
	clr	a
	movx	@dptr,a
	inc	dptr
	mov	a,#0x24
	...
	clr	a
	movx	@dptr,a
;	src/pwr_clk_mgmt_get_cclk_freq_in_hz.c:52: for(i = 0; i < divider; i++)
	mov	r6,#0x00
00101$:
	clr	c
	mov	a,r6
	subb	a,r7
	jnc	00104$
;	src/pwr_clk_mgmt_get_cclk_freq_in_hz.c:54: cclk_freq_hz /= 2;
	mov	dptr,#_pwr_clk_mgmt_get_cclk_freq_in_hz_cclk_freq_hz_1_1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
;	src/pwr_clk_mgmt_get_cclk_freq_in_hz.c:52: for(i = 0; i < divider; i++)
	...
	sjmp	00101$
00104$:
;	src/pwr_clk_mgmt_get_cclk_freq_in_hz.c:57: return cclk_freq_hz;
	mov	dptr,#_pwr_clk_mgmt_get_cclk_freq_in_hz_cclk_freq_hz_1_1
	movx	a,@dptr
	mov	r4,a
	inc	dptr
