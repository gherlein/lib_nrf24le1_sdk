...
;--------------------------------------------------------
	.module uart_calc_actual_baud_rate_from_th1
...
_uart_calc_actual_baud_rate_from_th1_PARM_2:
	.ds 1
_uart_calc_actual_baud_rate_from_th1_th1_reg_value_1_1:
	.ds 1
;--------------------------------------------------------
...
;th1_reg_value             Allocated with name '_uart_calc_actual_baud_rate_from_th1_th1_reg_value_1_1'
;------------------------------------------------------------
;	src/uart_calc_actual_baud_rate_from_th1.c:48: uint32_t uart_calc_actual_baud_rate_from_th1(uint8_t th1_reg_value, bool smod_bit_value)
;	-----------------------------------------
...
_uart_calc_actual_baud_rate_from_th1:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_uart_calc_actual_baud_rate_from_th1_th1_reg_value_1_1
	movx	@dptr,a
;	src/uart_calc_actual_baud_rate_from_th1.c:57: return (uint32_t)(((((uint32_t)(2 * ((smod_bit_value != 0) ? 2 : 1) * pwr_clk_mgmt_get_cclk_freq_in_hz())) / ((uint32_t)(384 * (256 - th1_reg_value)))) + 1) / 2);
