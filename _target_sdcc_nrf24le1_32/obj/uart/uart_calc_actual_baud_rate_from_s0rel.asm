...
; This file was generated Fri Jul 13 20:23:59 2012
;--------------------------------------------------------
	.module uart_calc_actual_baud_rate_from_s0rel
...
_uart_calc_actual_baud_rate_from_s0rel_PARM_2:
	.ds 1
_uart_calc_actual_baud_rate_from_s0rel_s0rel_reg_value_1_1:
	.ds 2
;--------------------------------------------------------
...
;s0rel_reg_value           Allocated with name '_uart_calc_actual_baud_rate_from_s0rel_s0rel_reg_value_1_1'
;------------------------------------------------------------
;	src/uart_calc_actual_baud_rate_from_s0rel.c:48: uint32_t uart_calc_actual_baud_rate_from_s0rel(uint16_t s0rel_reg_value, bool smod_bit_value)
;	-----------------------------------------
...
_uart_calc_actual_baud_rate_from_s0rel:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_uart_calc_actual_baud_rate_from_s0rel_s0rel_reg_value_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
;	src/uart_calc_actual_baud_rate_from_s0rel.c:57: return (uint32_t)(((((uint32_t)(2 * ((smod_bit_value != 0) ? 2 : 1) * pwr_clk_mgmt_get_cclk_freq_in_hz())) / ((uint32_t)(64 * (1024 - s0rel_reg_value)))) + 1) / 2);
