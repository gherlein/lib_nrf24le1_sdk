...
; This file was generated Fri Jul 13 20:24:00 2012
;--------------------------------------------------------
...
_uart_configure_auto_baud_calc_PARM_2:
	.ds 4
_uart_configure_auto_baud_calc_uart_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;uart_config_options       Allocated with name '_uart_configure_auto_baud_calc_uart_config_options_1_1'
;calc_br_with_smod_cleared Allocated with name '_uart_configure_auto_baud_calc_calc_br_with_smod_cleared_2_2'
;calc_br_with_smod_set     Allocated with name '_uart_configure_auto_baud_calc_calc_br_with_smod_set_2_2'
;error_calc_br_with_smod_cleared Allocated with name '_uart_configure_auto_baud_calc_error_calc_br_with_smod_cleared_2_2'
;error_calc_br_with_smod_set Allocated with name '_uart_configure_auto_baud_calc_error_calc_br_with_smod_set_2_2'
;s0rel_with_smod_cleared   Allocated with name '_uart_configure_auto_baud_calc_s0rel_with_smod_cleared_3_3'
;s0rel_with_smod_set       Allocated with name '_uart_configure_auto_baud_calc_s0rel_with_smod_set_3_3'
;th1_with_smod_cleared     Allocated with name '_uart_configure_auto_baud_calc_th1_with_smod_cleared_3_6'
;th1_with_smod_set         Allocated with name '_uart_configure_auto_baud_calc_th1_with_smod_set_3_6'
;------------------------------------------------------------
...
;	src/uart_configure_auto_baud_calc.c:51: if(((uart_config_options & UART_CONFIG_OPTION_MODE_MASK) == UART_CONFIG_OPTION_MODE_1_UART_8_BIT) ||
	mov	dptr,#_uart_configure_auto_baud_calc_uart_config_options_1_1
	movx	@dptr,a
	mov	r7,a
	mov	a,#0xC0
	anl	a,r7
