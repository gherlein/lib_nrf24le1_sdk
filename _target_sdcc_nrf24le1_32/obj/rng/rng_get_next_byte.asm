...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rng_get_next_byte'
;------------------------------------------------------------
;	src/rng_get_next_byte.c:46: uint8_t rng_get_next_byte()
;	-----------------------------------------
;	 function rng_get_next_byte
;	-----------------------------------------
_rng_get_next_byte:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/rng_get_next_byte.c:48: while(!rng_is_result_ready());
00101$:
	mov	a,#0x20
	anl	a,_RNGCTL
	mov	r7,a
	cjne	r7,#0x20,00101$
;	src/rng_get_next_byte.c:50: return rng_get_result();
	mov	dpl,_RNGDAT
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
