...
; This file was generated Sat Feb 18 15:32:24 2012
;--------------------------------------------------------
	.module rng_configure
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rng_configure_rng_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rng_configure'
;------------------------------------------------------------
;rng_config_options        Allocated with name '_rng_configure_rng_config_options_1_1'
;------------------------------------------------------------
;	src/rng_configure.c:52: void rng_configure(uint8_t rng_config_options)
;	-----------------------------------------
;	 function rng_configure
;	-----------------------------------------
_rng_configure:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rng_configure_rng_config_options_1_1
	movx	@dptr,a
;	src/rng_configure.c:55: RNGCTL = (RNGCTL & ~RNG_CONFIG_OPTION_RNGCTL_MASK) | (rng_config_options & RNG_CONFIG_OPTION_RNGCTL_MASK);
	mov	r7,_RNGCTL
	anl	ar7,#0x3F
	mov	dptr,#_rng_configure_rng_config_options_1_1
	movx	a,@dptr
