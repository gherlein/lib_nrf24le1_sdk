...
; This file was generated Sat Feb 18 15:32:25 2012
;--------------------------------------------------------
	.module rtc2_configure
...
_rtc2_configure_PARM_2:
	.ds 2
_rtc2_configure_rtc2_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;rtc2_config_options       Allocated with name '_rtc2_configure_rtc2_config_options_1_1'
;------------------------------------------------------------
;	src/rtc2_configure.c:53: void rtc2_configure(uint8_t rtc2_config_options, uint16_t compare_value)
;	-----------------------------------------
...
_rtc2_configure:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/rtc2_configure.c:56: if(((rtc2_config_options & RTC2CON_COMPARE_MODE_MASK) == RTC2_CONFIG_OPTION_COMPARE_MODE_0_RESET_AT_IRQ) ||
	mov	dptr,#_rtc2_configure_rtc2_config_options_1_1
	movx	@dptr,a
	mov	r7,a
	mov	a,#0x06
	anl	a,r7
	...
	sjmp	00101$
00107$:
;	src/rtc2_configure.c:57: ((rtc2_config_options & RTC2CON_COMPARE_MODE_MASK) == RTC2_CONFIG_OPTION_COMPARE_MODE_1_WRAP_AT_IRQ))
	mov	a,#0x06
	anl	a,r7
	mov	r6,a
	cjne	r6,#0x04,00102$
00101$:
;	src/rtc2_configure.c:59: RTC2CMP0 = (uint8_t)compare_value;
	...
	mov	r6,a
	mov	_RTC2CMP0,r5
;	src/rtc2_configure.c:60: RTC2CMP1 = (uint8_t)(compare_value >> 8);
	mov	_RTC2CMP1,r6
00102$:
;	src/rtc2_configure.c:64: RTC2CON = (RTC2CON & ~RTC2_CONFIG_OPTION_RTC2CON_MASK) | (rtc2_config_options & RTC2_CONFIG_OPTION_RTC2CON_MASK);
	mov	r6,_RTC2CON
	anl	ar6,#0xF0
	anl	ar7,#0x0F
	mov	a,r7
