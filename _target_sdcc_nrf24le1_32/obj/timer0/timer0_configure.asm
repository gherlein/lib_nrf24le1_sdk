...
; This file was generated Sat Feb 18 15:32:26 2012
;--------------------------------------------------------
	.module timer0_configure
...
_timer0_configure_PARM_2:
	.ds 2
_timer0_configure_timer0_config_options_1_1:
	.ds 1
;--------------------------------------------------------
...
;timer0_config_options     Allocated with name '_timer0_configure_timer0_config_options_1_1'
;------------------------------------------------------------
;	src/timer0_configure.c:53: void timer0_configure(uint8_t timer0_config_options, uint16_t t0_val)
;	-----------------------------------------
...
_timer0_configure:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/timer0_configure.c:56: if((timer0_config_options & TMOD_MODE0_MASK) == TIMER0_CONFIG_OPTION_MODE_2_8_BIT_AUTO_RLD_TMR)
	mov	dptr,#_timer0_configure_timer0_config_options_1_1
	movx	@dptr,a
	mov	r7,a
	mov	a,#0x03
	anl	a,r7
	mov	r6,a
	cjne	r6,#0x02,00102$
;	src/timer0_configure.c:58: TH0 = (uint8_t)t0_val;
	...
	mov	r6,a
	mov	_TH0,r5
;	src/timer0_configure.c:59: TL0 = (uint8_t)t0_val;
	mov	_TL0,r5
	sjmp	00103$
00102$:
;	src/timer0_configure.c:63: timer0_set_t0_val(t0_val);
	mov	dptr,#_timer0_configure_PARM_2
	movx	a,@dptr
	mov	_T0,a
	inc	dptr
	...
	mov	(_T0 >> 8),a
00103$:
;	src/timer0_configure.c:67: TMOD = (TMOD & ~TIMER0_CONFIG_OPTION_TMOD_MASK) | (timer0_config_options & TIMER0_CONFIG_OPTION_TMOD_MASK);
	mov	r6,_TMOD
	anl	ar6,#0xF0
	anl	ar7,#0x0F
	mov	a,r7
