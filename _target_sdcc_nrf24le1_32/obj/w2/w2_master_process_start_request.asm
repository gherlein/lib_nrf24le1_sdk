...
; This file was generated Wed Jun 27 14:28:57 2012
;--------------------------------------------------------
	.module w2_master_process_start_request
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_w2_master_process_start_request_send_start_stop_conditions_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'w2_master_process_start_request'
;------------------------------------------------------------
;send_start_stop_conditions Allocated with name '_w2_master_process_start_request_send_start_stop_conditions_1_1'
;------------------------------------------------------------
;	src/w2_master_process_start_request.c:47: void w2_master_process_start_request(w2_start_stop_condition_t send_start_stop_conditions)
;	-----------------------------------------
;	 function w2_master_process_start_request
;	-----------------------------------------
_w2_master_process_start_request:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
;	src/w2_master_process_start_request.c:49: switch(send_start_stop_conditions)
	mov	dptr,#_w2_master_process_start_request_send_start_stop_conditions_1_1
	movx	@dptr,a
	mov	r7,a
	jz	00102$
	cjne	r7,#0x02,00105$
;	src/w2_master_process_start_request.c:52: case W2_SEND_BOTH_START_AND_STOP_CONDITIONS:
00102$:
;	src/w2_master_process_start_request.c:53: w2_send_start_condition();
	orl	_W2CON0,#0x10
;	src/w2_master_process_start_request.c:58: };
00105$:
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
