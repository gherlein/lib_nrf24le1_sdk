...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_mspi_configure_mspi_config_options_1_1:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;mspi_config_options       Allocated with name '_mspi_configure_mspi_config_options_1_1'
;------------------------------------------------------------
...
_mspi_configure:
	...
	mov	r2,dph
	mov	a,dpl
	mov	dptr,#_mspi_configure_mspi_config_options_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r2
	movx	@dptr,a
