...
; This file was generated Mon Mar 26 13:48:56 2012
;--------------------------------------------------------
	.module rf_write_tx_payload_noack
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _rf_write_tx_payload_noack_PARM_3
	.globl _rf_write_tx_payload_noack_PARM_2
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_write_tx_payload_noack_PARM_2:
	.ds 2
_rf_write_tx_payload_noack_PARM_3:
	.ds 1
_rf_write_tx_payload_noack_dataptr_1_1:
	.ds 3
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_write_tx_payload_noack'
;------------------------------------------------------------
;len                       Allocated with name '_rf_write_tx_payload_noack_PARM_2'
;transmit                  Allocated with name '_rf_write_tx_payload_noack_PARM_3'
;dataptr                   Allocated with name '_rf_write_tx_payload_noack_dataptr_1_1'
;status                    Allocated with name '_rf_write_tx_payload_noack_status_1_1'
;------------------------------------------------------------
;	src/rf_write_tx_payload_noack.c:49: uint8_t rf_write_tx_payload_noack(uint8_t * dataptr, uint16_t len, bool transmit)
;	-----------------------------------------
;	 function rf_write_tx_payload_noack
;	-----------------------------------------
_rf_write_tx_payload_noack:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_write_tx_payload_noack_dataptr_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	movx	@dptr,a
	...
	mov	a,r7
	movx	@dptr,a
;	src/rf_write_tx_payload_noack.c:53: status = rf_spi_execute_command(RF_W_TX_PAYLOAD, dataptr, len, false); //Write the payload
	mov	dptr,#_rf_write_tx_payload_noack_dataptr_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	r7,dpl
;	src/rf_write_tx_payload_noack.c:56: if(transmit == true)
	mov	dptr,#_rf_write_tx_payload_noack_PARM_3
	movx	a,@dptr
	mov	r6,a
	cjne	r6,#0x01,00102$
;	src/rf_write_tx_payload_noack.c:58: rf_transmit();
	push	ar7
	lcall	_rf_transmit
	pop	ar7
00102$:
;	src/rf_write_tx_payload_noack.c:61: return status; //Return the value of STATUS
	mov	dpl,r7
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
