...
; This file was generated Mon Mar 26 13:48:55 2012
;--------------------------------------------------------
	.module rf_write_tx_ack_payload
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _rf_write_tx_ack_payload_PARM_2
	.globl _rf_write_tx_ack_payload
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_write_tx_ack_payload_PARM_2:
	.ds 2
_rf_write_tx_ack_payload_dataptr_1_1:
	.ds 3
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_write_tx_ack_payload'
;------------------------------------------------------------
;len                       Allocated with name '_rf_write_tx_ack_payload_PARM_2'
;dataptr                   Allocated with name '_rf_write_tx_ack_payload_dataptr_1_1'
;status                    Allocated with name '_rf_write_tx_ack_payload_status_1_1'
;------------------------------------------------------------
;	src/rf_write_tx_ack_payload.c:48: uint8_t rf_write_tx_ack_payload(uint8_t * dataptr, uint16_t len)
;	-----------------------------------------
;	 function rf_write_tx_ack_payload
;	-----------------------------------------
_rf_write_tx_ack_payload:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_write_tx_ack_payload_dataptr_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	movx	@dptr,a
	...
	mov	a,r7
	movx	@dptr,a
;	src/rf_write_tx_ack_payload.c:52: status = rf_spi_execute_command(RF_W_ACK_PAYLOAD, dataptr, len, false); //Write the ack payload
	mov	dptr,#_rf_write_tx_ack_payload_dataptr_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_rf_write_tx_ack_payload_PARM_2
	movx	a,@dptr
	mov	r3,a
	inc	dptr
	movx	a,@dptr
	...
	movx	@dptr,a
	mov	dpl,#0xA1
;	src/rf_write_tx_ack_payload.c:54: return status; //Return the value of STATUS
