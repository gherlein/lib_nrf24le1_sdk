...
; This file was generated Mon Mar 26 13:48:54 2012
;--------------------------------------------------------
	.module rf_write_register
...
_rf_write_register_PARM_3:
	.ds 2
_rf_write_register_regnumber_1_1:
	.ds 1
;--------------------------------------------------------
...
;regnumber                 Allocated with name '_rf_write_register_regnumber_1_1'
;------------------------------------------------------------
;	src/rf_write_register.c:49: uint8_t rf_write_register(uint8_t regnumber, uint8_t * dataptr, uint16_t len)
;	-----------------------------------------
...
_rf_write_register:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/rf_write_register.c:52: return rf_spi_execute_command(RF_W_REGISTER | (regnumber & RF_W_REGISTER_DATA), dataptr, len, false);
	mov	dptr,#_rf_write_register_regnumber_1_1
	movx	@dptr,a
	mov	r7,a
	mov	a,#0x1F
	anl	a,r7
