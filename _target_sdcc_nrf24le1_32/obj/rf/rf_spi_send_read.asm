...
; This file was generated Mon Mar 26 13:48:51 2012
;--------------------------------------------------------
	.module rf_spi_send_read
...
;dataptr                   Allocated with name '_rf_spi_send_read_dataptr_1_1'
;i                         Allocated with name '_rf_spi_send_read_i_1_1'
;tempbyte                  Allocated with name '_rf_spi_send_read_tempbyte_1_1'
;------------------------------------------------------------
;	src/rf_spi_send_read.c:49: void rf_spi_send_read(uint8_t * dataptr, uint16_t len, bool copydata)
;	-----------------------------------------
...
_rf_spi_send_read:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_spi_send_read_dataptr_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	movx	@dptr,a
	...
	mov	a,r7
	movx	@dptr,a
;	src/rf_spi_send_read.c:55: for(i = 0; i < len; i++)
	mov	dptr,#_rf_spi_send_read_dataptr_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
...
00103$:
	...
	subb	a,r3
	jnc	00107$
;	src/rf_spi_send_read.c:57: tempbyte = rf_spi_send_read_byte(dataptr[i]); //Send the value, and then save the received value
	push	ar2
	push	ar3
	mov	a,r0
	add	a,r5
	...
	pop	ar6
	pop	ar7
;	src/rf_spi_send_read.c:60: if(copydata != false)
	pop	ar3
	pop	ar2
	mov	a,r4
	jz	00105$
;	src/rf_spi_send_read.c:62: dataptr[i] = tempbyte;
	mov	dpl,_rf_spi_send_read_sloc0_1_0
	mov	dph,(_rf_spi_send_read_sloc0_1_0 + 1)
	mov	b,(_rf_spi_send_read_sloc0_1_0 + 2)
