...
; This file was generated Mon Mar 26 13:48:44 2012
;--------------------------------------------------------
	.module rf_read_register
...
_rf_read_register_PARM_3:
	.ds 2
_rf_read_register_regnumber_1_1:
	.ds 1
;--------------------------------------------------------
...
;regnumber                 Allocated with name '_rf_read_register_regnumber_1_1'
;------------------------------------------------------------
;	src/rf_read_register.c:49: uint8_t rf_read_register(uint8_t regnumber, uint8_t * dataptr, uint16_t len)
;	-----------------------------------------
...
_rf_read_register:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/rf_read_register.c:52: return rf_spi_execute_command(regnumber & RF_R_REGISTER_DATA, dataptr, len, true);
	mov	dptr,#_rf_read_register_regnumber_1_1
	movx	@dptr,a
	mov	r7,a
	anl	ar7,#0x1F
