...
; This file was generated Mon Mar 26 13:48:52 2012
;--------------------------------------------------------
	.module rf_spi_send_read_byte
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_spi_send_read_byte_byte_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;byte                      Allocated with name '_rf_spi_send_read_byte_byte_1_1'
;------------------------------------------------------------
;	src/rf_spi_send_read_byte.c:47: uint8_t rf_spi_send_read_byte(uint8_t byte)
;	-----------------------------------------
...
_rf_spi_send_read_byte:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/rf_spi_send_read_byte.c:49: SPIRDAT = byte; //Send byte over SPI
	mov	dptr,#_rf_spi_send_read_byte_byte_1_1
	movx	@dptr,a
	mov	_SPIRDAT,a
;	src/rf_spi_send_read_byte.c:51: while(!(SPIRSTAT & SPIRSTAT_IRQ_RX_FIFO_READY)); //Wait for the transaction to finish
00101$:
	mov	a,_SPIRSTAT
	jnb	acc.2,00101$
;	src/rf_spi_send_read_byte.c:53: IRCON_SB_RFRDY = BIT_FALSE; //Clear the IRQ bit
	clr	_IRCON_SB_RFRDY
;	src/rf_spi_send_read_byte.c:55: return SPIRDAT; //Return the received value
	mov	dpl,_SPIRDAT
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
