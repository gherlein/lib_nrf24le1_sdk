...
; This file was generated Mon Mar 26 13:48:53 2012
;--------------------------------------------------------
	.module rf_tx_fifo_is_empty
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_tx_fifo_is_empty_fifo_status_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_tx_fifo_is_empty'
;------------------------------------------------------------
;fifo_status               Allocated with name '_rf_tx_fifo_is_empty_fifo_status_1_1'
;------------------------------------------------------------
;	src/rf_tx_fifo_is_empty.c:47: bool rf_tx_fifo_is_empty()
;	-----------------------------------------
;	 function rf_tx_fifo_is_empty
;	-----------------------------------------
_rf_tx_fifo_is_empty:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/rf_tx_fifo_is_empty.c:51: rf_read_register(RF_FIFO_STATUS, &fifo_status, 1);
	mov	dptr,#_rf_read_register_PARM_2
	mov	a,#_rf_tx_fifo_is_empty_fifo_status_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,#(_rf_tx_fifo_is_empty_fifo_status_1_1 >> 8)
	movx	@dptr,a
	inc	dptr
	clr	a
	movx	@dptr,a
...
;	src/rf_tx_fifo_is_empty.c:53: return (fifo_status & RF_FIFO_STATUS_TX_EMPTY) ? true : false;
	mov	dptr,#_rf_tx_fifo_is_empty_fifo_status_1_1
	movx	a,@dptr
	mov	r7,a
	jnb	acc.4,00103$
	mov	r7,#0x01
