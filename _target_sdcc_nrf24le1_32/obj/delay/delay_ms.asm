...
; This file was generated Sat Feb 18 15:31:46 2012
;--------------------------------------------------------
	.module delay_ms
...
;------------------------------------------------------------
;milliseconds              Allocated with name '_delay_ms_milliseconds_1_1'
;count                     Allocated with name '_delay_ms_count_1_1'
;------------------------------------------------------------
;	src/delay_ms.c:46: void delay_ms(uint16_t milliseconds)
;	-----------------------------------------
;	 function delay_ms
;	-----------------------------------------
_delay_ms:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay_ms_milliseconds_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
;	src/delay_ms.c:51: for(count = 0; count < milliseconds; count++)
	mov	dptr,#_delay_ms_milliseconds_1_1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00101$:
	...
	subb	a,r7
	jnc	00105$
;	src/delay_ms.c:53: delay_us(1000);
	mov	dptr,#0x03E8
	push	ar7
	push	ar6
	push	ar5
