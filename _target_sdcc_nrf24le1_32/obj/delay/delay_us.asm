...
; This file was generated Sat Feb 18 15:31:47 2012
;--------------------------------------------------------
	.module delay_us
...
;------------------------------------------------------------
;microseconds              Allocated with name '_delay_us_microseconds_1_1'
;count                     Allocated with name '_delay_us_count_1_1'
;------------------------------------------------------------
;	src/delay_us.c:46: void delay_us(uint16_t microseconds)
;	-----------------------------------------
;	 function delay_us
;	-----------------------------------------
_delay_us:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay_us_microseconds_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
;	src/delay_us.c:51: if(microseconds == 0)
	mov	dptr,#_delay_us_microseconds_1_1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	orl	a,r6
	jnz	00102$
;	src/delay_us.c:52: return;
	ret
00102$:
;	src/delay_us.c:54: microseconds -= 1;
	dec	r6
	cjne	r6,#0xFF,00115$
	dec	r7
00115$:
	...
	mov	a,r7
	movx	@dptr,a
;	src/delay_us.c:56: for(count = 0; count < microseconds; count++)
	mov	dptr,#_delay_us_microseconds_1_1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00104$:
	...
	subb	a,r7
	jnc	00108$
;	src/delay_us.c:58: nop();
	 nop 
;	src/delay_us.c:59: nop();
	 nop 
;	src/delay_us.c:56: for(count = 0; count < microseconds; count++)
	inc	r4
	cjne	r4,#0x00,00104$
