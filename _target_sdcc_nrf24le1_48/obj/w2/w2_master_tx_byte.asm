...
; This file was generated Wed Jun 27 14:30:31 2012
;--------------------------------------------------------
	.module w2_master_tx_byte
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _w2_master_tx_byte_PARM_2
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_w2_master_tx_byte_PARM_2:
	.ds 1
_w2_master_tx_byte_tx_data_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'w2_master_tx_byte'
;------------------------------------------------------------
;send_start_stop_conditions Allocated with name '_w2_master_tx_byte_PARM_2'
;tx_data                   Allocated with name '_w2_master_tx_byte_tx_data_1_1'
;temp_w2con1               Allocated with name '_w2_master_tx_byte_temp_w2con1_1_1'
;------------------------------------------------------------
;	src/w2_master_tx_byte.c:49: w2_ack_nack_val_t w2_master_tx_byte(uint8_t tx_data, w2_start_stop_condition_t send_start_stop_conditions)
;	-----------------------------------------
;	 function w2_master_tx_byte
;	-----------------------------------------
_w2_master_tx_byte:
	ar7 = 0x07
	ar6 = 0x06
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_w2_master_tx_byte_tx_data_1_1
	movx	@dptr,a
;	src/w2_master_tx_byte.c:54: w2_master_process_start_request(send_start_stop_conditions);
	...
	pop	ar7
;	src/w2_master_tx_byte.c:57: w2_send_byte(tx_data);
	mov	dptr,#_w2_master_tx_byte_tx_data_1_1
	movx	a,@dptr
	mov	_W2DAT,a
;	src/w2_master_tx_byte.c:60: w2_master_process_stop_request(send_start_stop_conditions);
	mov	dpl,r7
	lcall	_w2_master_process_stop_request
;	src/w2_master_tx_byte.c:63: temp_w2con1 = w2_wait_for_byte_tx_or_rx();
	lcall	_w2_wait_for_byte_tx_or_rx
	mov	a,dpl
;	src/w2_master_tx_byte.c:66: return w2_get_last_rxed_ack(temp_w2con1);
	jnb	acc.1,00103$
	mov	r7,#0x01
	sjmp	00104$
00103$:
