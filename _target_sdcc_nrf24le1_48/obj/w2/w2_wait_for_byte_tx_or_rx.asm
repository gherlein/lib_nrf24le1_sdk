...
; This file was generated Wed Jun 27 14:30:40 2012
;--------------------------------------------------------
	.module w2_wait_for_byte_tx_or_rx
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_w2_wait_for_byte_tx_or_rx_local_w2con1_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'w2_wait_for_byte_tx_or_rx'
;------------------------------------------------------------
;local_w2con1              Allocated with name '_w2_wait_for_byte_tx_or_rx_local_w2con1_1_1'
;------------------------------------------------------------
;	src/w2_wait_for_byte_tx_or_rx.c:46: uint8_t w2_wait_for_byte_tx_or_rx()
;	-----------------------------------------
;	 function w2_wait_for_byte_tx_or_rx
;	-----------------------------------------
_w2_wait_for_byte_tx_or_rx:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/w2_wait_for_byte_tx_or_rx.c:53: w2_wait_for_irq();
00101$:
	jbc	_IRCON_SB_SPI_2WIRE,00112$
	sjmp	00101$
00112$:
;	src/w2_wait_for_byte_tx_or_rx.c:54: local_w2con1 = W2CON1;
;	src/w2_wait_for_byte_tx_or_rx.c:55: } while(!w2_data_txed_or_rxed(local_w2con1));
	mov	dptr,#_w2_wait_for_byte_tx_or_rx_local_w2con1_1_1
	mov	a,_W2CON1
	movx	@dptr,a
	movx	a,@dptr
	mov	r7,a
	jnb	acc.0,00101$
;	src/w2_wait_for_byte_tx_or_rx.c:57: return local_w2con1;
	mov	dpl,r7
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
