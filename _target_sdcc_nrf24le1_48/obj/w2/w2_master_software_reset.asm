...
; This file was generated Wed Jun 27 14:30:29 2012
;--------------------------------------------------------
	.module w2_master_software_reset
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_w2_master_software_reset_w2con0_copy_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'w2_master_software_reset'
;------------------------------------------------------------
;w2con0_copy               Allocated with name '_w2_master_software_reset_w2con0_copy_1_1'
;------------------------------------------------------------
;	src/w2_master_software_reset.c:50: void w2_master_software_reset()
;	-----------------------------------------
;	 function w2_master_software_reset
;	-----------------------------------------
_w2_master_software_reset:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/w2_master_software_reset.c:55: w2con0_copy = W2CON0;
	mov	dptr,#_w2_master_software_reset_w2con0_copy_1_1
	mov	a,_W2CON0
	movx	@dptr,a
;	src/w2_master_software_reset.c:58: w2_prepare_scl_sda();
	 clr _P1_SB_D2 
	 clr _P1_SB_D3 
;	src/w2_master_software_reset.c:62: w2_clear_scl();
	anl	_P1,#0xFB
;	src/w2_master_software_reset.c:63: w2_set_sda();
	orl	_P1,#0x08
;	src/w2_master_software_reset.c:66: w2_master_set_clock_idle();
	anl	_W2CON0,#0xF3
;	src/w2_master_software_reset.c:67: w2_master_set_clock_100_khz();
	mov	r7,_W2CON0
	mov	a,#0xF3
	anl	a,r7
	orl	a,#0x04
	mov	_W2CON0,a
;	src/w2_master_software_reset.c:68: w2_disable();
	anl	_W2CON0,#0xFE
;	src/w2_master_software_reset.c:69: delay_us(5);
	mov	dptr,#0x0005
	lcall	_delay_us
;	src/w2_master_software_reset.c:72: w2_clear_sda();
	anl	_P1,#0xF7
;	src/w2_master_software_reset.c:73: delay_us(5);
	mov	dptr,#0x0005
	lcall	_delay_us
;	src/w2_master_software_reset.c:76: w2_set_scl();
	orl	_P1,#0x04
;	src/w2_master_software_reset.c:77: delay_us(5);
	mov	dptr,#0x0005
	lcall	_delay_us
;	src/w2_master_software_reset.c:80: w2_set_sda();
	orl	_P1,#0x08
;	src/w2_master_software_reset.c:81: delay_us(5);
	mov	dptr,#0x0005
	lcall	_delay_us
;	src/w2_master_software_reset.c:84: W2CON0 = w2con0_copy;
	mov	dptr,#_w2_master_software_reset_w2con0_copy_1_1
	movx	a,@dptr
	mov	_W2CON0,a
	ret
