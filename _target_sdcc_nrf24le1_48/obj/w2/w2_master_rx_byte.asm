...
; This file was generated Wed Jun 27 14:30:26 2012
;--------------------------------------------------------
	.module w2_master_rx_byte
	.optsdcc -mmcs51 --model-large
	
;--------------------------------------------------------
; Public variables in this module
;--------------------------------------------------------
	.globl _w2_wait_for_byte_tx_or_rx
	.globl _w2_master_process_stop_request
	.globl _w2_master_process_start_request
	.globl _FSR_SB_ENDBG
	.globl _FSR_SB_STP
	.globl _FSR_SB_WEN
	.globl _FSR_SB_RDYN
	...
	.globl _SP
	.globl _P0
	.globl _w2_master_rx_byte_PARM_2
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_w2_master_rx_byte_PARM_2:
	.ds 1
_w2_master_rx_byte_rx_byte_1_1:
	.ds 3
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'w2_master_rx_byte'
;------------------------------------------------------------
;send_start_stop_conditions Allocated with name '_w2_master_rx_byte_PARM_2'
;rx_byte                   Allocated with name '_w2_master_rx_byte_rx_byte_1_1'
;temp_w2con1               Allocated with name '_w2_master_rx_byte_temp_w2con1_1_1'
;------------------------------------------------------------
;	src/w2_master_rx_byte.c:48: w2_ack_nack_val_t w2_master_rx_byte(uint8_t * rx_byte, w2_start_stop_condition_t send_start_stop_conditions)
;	-----------------------------------------
;	 function w2_master_rx_byte
;	-----------------------------------------
_w2_master_rx_byte:
	ar7 = 0x07
	ar6 = 0x06
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_w2_master_rx_byte_rx_byte_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	movx	@dptr,a
	...
	mov	a,r7
	movx	@dptr,a
;	src/w2_master_rx_byte.c:53: w2_master_process_start_request(send_start_stop_conditions);
	mov	dptr,#_w2_master_rx_byte_PARM_2
	movx	a,@dptr
	mov	r7,a
	mov	dpl,a
	push	ar7
	lcall	_w2_master_process_start_request
	pop	ar7
;	src/w2_master_rx_byte.c:54: w2_master_process_stop_request(send_start_stop_conditions);
	mov	dpl,r7
	lcall	_w2_master_process_stop_request
;	src/w2_master_rx_byte.c:57: temp_w2con1 = w2_wait_for_byte_tx_or_rx();
	lcall	_w2_wait_for_byte_tx_or_rx
	mov	r7,dpl
;	src/w2_master_rx_byte.c:60: (*rx_byte) = w2_get_rxed_byte();
	mov	dptr,#_w2_master_rx_byte_rx_byte_1_1
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	mov	a,_W2DAT
	lcall	__gptrput
;	src/w2_master_rx_byte.c:63: return w2_get_last_rxed_ack(temp_w2con1);
	mov	a,r7
	jnb	acc.1,00103$
	mov	r7,#0x01
	sjmp	00104$
