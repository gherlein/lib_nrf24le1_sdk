...
; This file was generated Fri Mar 23 15:39:14 2012
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_watchdog_start_and_set_timeout_in_ms_milliseconds_1_1:
	.ds 4
_watchdog_start_and_set_timeout_in_ms_wd_value_1_1:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;milliseconds              Allocated with name '_watchdog_start_and_set_timeout_in_ms_milliseconds_1_1'
;wd_value                  Allocated with name '_watchdog_start_and_set_timeout_in_ms_wd_value_1_1'
;------------------------------------------------------------
;	src/watchdog_start_and_set_timeout_in_ms.c:50: uint16_t watchdog_start_and_set_timeout_in_ms(uint32_t milliseconds)
;	-----------------------------------------
...
_watchdog_start_and_set_timeout_in_ms:
	...
	mov	r5,b
	mov	r4,a
	mov	dptr,#_watchdog_start_and_set_timeout_in_ms_milliseconds_1_1
	mov	a,r7
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	...
	mov	a,r4
	movx	@dptr,a
;	src/watchdog_start_and_set_timeout_in_ms.c:52: uint16_t wd_value = 0;
	mov	dptr,#_watchdog_start_and_set_timeout_in_ms_wd_value_1_1
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	src/watchdog_start_and_set_timeout_in_ms.c:55: if(!pwr_clk_mgmt_is_clklf_enabled())
	mov	a,#0x07
	anl	a,_CLKLFCTRL
	mov	r7,a
	cjne	r7,#0x07,00105$
;	src/watchdog_start_and_set_timeout_in_ms.c:58: pwr_clk_mgmt_clklf_configure(PWR_CLK_MGMT_CLKLF_CONFIG_OPTION_CLK_SRC_XOSC16M);
	mov	dpl,#0x02
	lcall	_pwr_clk_mgmt_clklf_configure
;	src/watchdog_start_and_set_timeout_in_ms.c:59: pwr_clk_mgmt_wait_until_clklf_is_ready();
00101$:
	mov	a,_CLKLFCTRL
	jnb	acc.6,00101$
00105$:
;	src/watchdog_start_and_set_timeout_in_ms.c:63: if(milliseconds < 511992)
	mov	dptr,#_watchdog_start_and_set_timeout_in_ms_milliseconds_1_1
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	subb	a,#0x00
	jnc	00107$
;	src/watchdog_start_and_set_timeout_in_ms.c:90: wd_value = (uint16_t)(((uint32_t)(milliseconds * ((uint32_t)128)) + (uint32_t)500) / ((uint32_t)1000));
	mov	a,r7
	anl	a,#0x01
	mov	c,acc.0
	xch	a,r6
	...
	movx	@dptr,a
00107$:
;	src/watchdog_start_and_set_timeout_in_ms.c:93: watchdog_set_wdsv_count(wd_value);
	mov	dptr,#_watchdog_start_and_set_timeout_in_ms_wd_value_1_1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	pop	ar6
	pop	ar7
;	src/watchdog_start_and_set_timeout_in_ms.c:95: return wd_value;
	mov	dpl,r6
	mov	dph,r7
	ret
	.area CSEG    (CODE)
