...
; This file was generated Sat Feb 18 15:32:52 2012
;--------------------------------------------------------
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _memory_flash_can_byte_be_written_without_page_erase_PARM_2
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_memory_flash_can_byte_be_written_without_page_erase_PARM_2:
	.ds 1
_memory_flash_can_byte_be_written_without_page_erase_cur_flash_val_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'memory_flash_can_byte_be_written_without_page_erase'
;------------------------------------------------------------
;write_val                 Allocated with name '_memory_flash_can_byte_be_written_without_page_erase_PARM_2'
;cur_flash_val             Allocated with name '_memory_flash_can_byte_be_written_without_page_erase_cur_flash_val_1_1'
;temp_val                  Allocated with name '_memory_flash_can_byte_be_written_without_page_erase_temp_val_1_1'
;------------------------------------------------------------
;	src/memory_flash_can_byte_be_written_without_erase.c:49: bool memory_flash_can_byte_be_written_without_page_erase(uint8_t cur_flash_val, uint8_t write_val)
;	-----------------------------------------
;	 function memory_flash_can_byte_be_written_without_page_erase
;	-----------------------------------------
_memory_flash_can_byte_be_written_without_page_erase:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_memory_flash_can_byte_be_written_without_page_erase_cur_flash_val_1_1
	movx	@dptr,a
;	src/memory_flash_can_byte_be_written_without_erase.c:55: temp_val = cur_flash_val ^ write_val;
	...
	mov	a,r7
	xrl	a,r6
;	src/memory_flash_can_byte_be_written_without_erase.c:61: temp_val &= cur_flash_val;
	anl	a,r6
;	src/memory_flash_can_byte_be_written_without_erase.c:66: if(temp_val == 0)
	jnz	00102$
;	src/memory_flash_can_byte_be_written_without_erase.c:68: return true;
	mov	dpl,#0x01
	ret
00102$:
;	src/memory_flash_can_byte_be_written_without_erase.c:72: return false;
	mov	dpl,#0x00
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
