...
; This file was generated Sat Feb 18 15:32:58 2012
;--------------------------------------------------------
	.module pwm_start
...
;pwm_channel               Allocated with name '_pwm_start_pwm_channel_1_1'
;------------------------------------------------------------
;	src/pwm_start.c:47: void pwm_start(pwm_channel_t pwm_channel, uint8_t pwm_duty_cycle)
;	-----------------------------------------
;	 function pwm_start
;	-----------------------------------------
_pwm_start:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/pwm_start.c:50: if(pwm_channel == PWM_CHANNEL_0)
	mov	dptr,#_pwm_start_pwm_channel_1_1
	movx	@dptr,a
	mov	r7,a
	jnz	00102$
;	src/pwm_start.c:52: PWMDC0 = pwm_duty_cycle;
	mov	dptr,#_pwm_start_PARM_2
	movx	a,@dptr
	mov	_PWMDC0,a
;	src/pwm_start.c:53: reg_bits_set(PWMCON, PWMCON_PWM0_ENABLE);
	orl	_PWMCON,#0x01
	ret
00102$:
;	src/pwm_start.c:57: PWMDC1 = pwm_duty_cycle;
	mov	dptr,#_pwm_start_PARM_2
	movx	a,@dptr
	mov	_PWMDC1,a
;	src/pwm_start.c:58: reg_bits_set(PWMCON, PWMCON_PWM1_ENABLE);
	orl	_PWMCON,#0x02
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
