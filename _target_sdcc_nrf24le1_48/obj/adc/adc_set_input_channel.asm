...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_adc_set_input_channel_adc_channel_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;adc_channel               Allocated with name '_adc_set_input_channel_adc_channel_1_1'
;------------------------------------------------------------
;	src/adc_set_input_channel.c:46: void adc_set_input_channel(adc_channel_t adc_channel)
;	-----------------------------------------
...
_adc_set_input_channel:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/adc_set_input_channel.c:49: adc_channel &= (ADCCON1_CHAN_SEL_MASK >> ADCCON1_CHAN_SEL_SHIFT);
	mov	dptr,#_adc_set_input_channel_adc_channel_1_1
	movx	@dptr,a
	mov	r7,a
	mov	dptr,#_adc_set_input_channel_adc_channel_1_1
	mov	a,#0x0F
	anl	a,r7
	movx	@dptr,a
;	src/adc_set_input_channel.c:52: ADCCON1 = (ADCCON1 & ~ADCCON1_CHAN_SEL_MASK) | (adc_channel << ADCCON1_CHAN_SEL_SHIFT);
	mov	r7,_ADCCON1
	anl	ar7,#0xC3
	mov	dptr,#_adc_set_input_channel_adc_channel_1_1
	movx	a,@dptr
