...
;--------------------------------------------------------
	.module adc_start_single_conversion
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_adc_start_single_conversion_adc_channel_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;adc_channel               Allocated with name '_adc_start_single_conversion_adc_channel_1_1'
;------------------------------------------------------------
;	src/adc_start_single_conversion.c:47: void adc_start_single_conversion(adc_channel_t adc_channel)
;	-----------------------------------------
...
_adc_start_single_conversion:
	...
	ar0 = 0x00
	mov	a,dpl
;	src/adc_start_single_conversion.c:49: adc_set_input_channel(adc_channel);
	mov	dptr,#_adc_start_single_conversion_adc_channel_1_1
	movx	@dptr,a
	mov	dpl,a
	lcall	_adc_set_input_channel
;	src/adc_start_single_conversion.c:52: adc_power_up();
	orl	_ADCCON1,#0x80
;	src/adc_start_single_conversion.c:53: nop(); nop(); nop(); nop(); //4 clock cycles must elapse before busy flag is set (datasheet v1.3, p. 165)
	 nop 
	 nop 
	 nop 
	 nop 
