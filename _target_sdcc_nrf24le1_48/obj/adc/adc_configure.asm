...
; This file was generated Sat Feb 18 15:32:44 2012
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_adc_configure_adc_config_options_1_1:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;adc_config_options        Allocated with name '_adc_configure_adc_config_options_1_1'
;------------------------------------------------------------
;	src/adc_configure.c:54: void adc_configure(uint16_t adc_config_options)
;	-----------------------------------------
...
_adc_configure:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_adc_configure_adc_config_options_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	movx	@dptr,a
;	src/adc_configure.c:57: ADCCON3 = (ADCCON3 & ~ADC_CONFIG_OPTION_ADCCON3_WRITE_MASK) | (((uint8_t)(adc_config_options >> ADC_CONFIG_OPTION_ADCCON3_OFFSET_SHIFT)) & ADC_CONFIG_OPTION_ADCCON3_WRITE_MASK);
	mov	r7,_ADCCON3
	anl	ar7,#0x1F
	mov	dptr,#_adc_configure_adc_config_options_1_1
	movx	a,@dptr
	...
	orl	ar7,a
	mov	_ADCCON3,r7
;	src/adc_configure.c:58: ADCCON2 = (ADCCON2 & ~ADC_CONFIG_OPTION_ADCCON2_WRITE_MASK) | (((uint8_t)(adc_config_options >> ADC_CONFIG_OPTION_ADCCON2_OFFSET_SHIFT)) & ADC_CONFIG_OPTION_ADCCON2_WRITE_MASK);
	mov	a,_ADCCON2
	mov	_ADCCON2,r5
;	src/adc_configure.c:59: ADCCON1 = (ADCCON1 & ~ADC_CONFIG_OPTION_ADCCON1_WRITE_MASK) | (((uint8_t)(adc_config_options >> ADC_CONFIG_OPTION_ADCCON1_OFFSET_SHIFT)) & ADC_CONFIG_OPTION_ADCCON1_WRITE_MASK);
	mov	r7,_ADCCON1
	anl	ar7,#0xFC
	anl	ar4,#0x03
	mov	a,r4
	orl	ar7,a
	mov	_ADCCON1,r7
;	src/adc_configure.c:62: nop(); nop(); nop(); nop(); //4 clock cycles must elapse before busy flag is set (datasheet v1.3, p. 165)
	 nop 
	 nop 
	 nop 
	 nop 
