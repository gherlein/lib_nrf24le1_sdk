...
_uart_calc_th1_value_PARM_2:
	.ds 1
_uart_calc_th1_value_desired_baud_rate_1_1:
	.ds 4
;--------------------------------------------------------
...
;desired_baud_rate         Allocated with name '_uart_calc_th1_value_desired_baud_rate_1_1'
;------------------------------------------------------------
;	src/uart_calc_th1_value.c:48: uint8_t uart_calc_th1_value(uint32_t desired_baud_rate, bool smod_bit_value)
;	-----------------------------------------
...
_uart_calc_th1_value:
	...
	mov	r5,b
	mov	r4,a
	mov	dptr,#_uart_calc_th1_value_desired_baud_rate_1_1
	mov	a,r7
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	...
	mov	a,r4
	movx	@dptr,a
;	src/uart_calc_th1_value.c:57: return (uint8_t)(256 - (((((uint32_t)(2 * ((smod_bit_value != 0) ? 2 : 1) * pwr_clk_mgmt_get_cclk_freq_in_hz())) / ((uint32_t)(384 * desired_baud_rate))) + 1) / 2));
