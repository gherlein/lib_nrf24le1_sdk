...
;--------------------------------------------------------
	.module uart_send_wait_for_complete
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_uart_send_wait_for_complete_tx_data_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'uart_send_wait_for_complete'
;------------------------------------------------------------
;tx_data                   Allocated with name '_uart_send_wait_for_complete_tx_data_1_1'
;------------------------------------------------------------
;	src/uart_send_wait_for_complete.c:47: void uart_send_wait_for_complete(uint8_t tx_data)
;	-----------------------------------------
;	 function uart_send_wait_for_complete
;	-----------------------------------------
_uart_send_wait_for_complete:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
;	src/uart_send_wait_for_complete.c:49: uart_send(tx_data);
	mov	dptr,#_uart_send_wait_for_complete_tx_data_1_1
	movx	@dptr,a
	mov	_S0BUF,a
;	src/uart_send_wait_for_complete.c:51: while(!uart_tx_data_sent());
00101$:
;	src/uart_send_wait_for_complete.c:53: interrupt_clear_uart_tx();
	jbc	_S0CON_SB_TI0,00108$
	sjmp	00101$
00108$:
	ret
	.area CSEG    (CODE)
