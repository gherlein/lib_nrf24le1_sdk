...
; This file was generated Sat Feb 18 15:32:47 2012
;--------------------------------------------------------
	.module gpio_pin_complement
	.optsdcc -mmcs51 --model-large
	
;--------------------------------------------------------
; Public variables in this module
;--------------------------------------------------------
	.globl _gpio_pin_complement
	.globl _FSR_SB_ENDBG
	.globl _FSR_SB_STP
	.globl _FSR_SB_WEN
	.globl _FSR_SB_RDYN
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_gpio_pin_complement_gpio_pin_id_1_1:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'gpio_pin_complement'
;------------------------------------------------------------
;gpio_pin_id               Allocated with name '_gpio_pin_complement_gpio_pin_id_1_1'
;------------------------------------------------------------
;	src/gpio_pin_complement.c:46: void gpio_pin_complement(gpio_pin_id_t gpio_pin_id)
;	-----------------------------------------
;	 function gpio_pin_complement
;	-----------------------------------------
_gpio_pin_complement:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
;	src/gpio_pin_complement.c:49: if(gpio_pin_id <= GPIO_PIN_ID_P0_7)
	mov	dptr,#_gpio_pin_complement_gpio_pin_id_1_1
	movx	@dptr,a
	mov  r7,a
	add	a,#0xff - 0x07
	jc	00110$
;	src/gpio_pin_complement.c:51: gpio_pins_val_complement(P0, (1 << (gpio_pin_id % 8)));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00121$:
	...
	ret
00110$:
;	src/gpio_pin_complement.c:53: else if(gpio_pin_id <= GPIO_PIN_ID_P1_7)
	mov	a,r7
	add	a,#0xff - 0x0F
	jc	00107$
;	src/gpio_pin_complement.c:55: gpio_pins_val_complement(P1, (1 << (gpio_pin_id % 8)));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00125$:
	...
	ret
00107$:
;	src/gpio_pin_complement.c:58: else if(gpio_pin_id <= GPIO_PIN_ID_P2_7)
	mov	a,r7
	add	a,#0xff - 0x17
	jc	00104$
;	src/gpio_pin_complement.c:60: gpio_pins_val_complement(P2, (1 << (gpio_pin_id % 8)));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00129$:
	...
	ret
00104$:
;	src/gpio_pin_complement.c:62: else if(gpio_pin_id <= GPIO_PIN_ID_P3_6)
	mov	a,r7
	add	a,#0xff - 0x1E
	jc	00112$
;	src/gpio_pin_complement.c:64: gpio_pins_val_complement(P3, (1 << (gpio_pin_id % 8)));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
