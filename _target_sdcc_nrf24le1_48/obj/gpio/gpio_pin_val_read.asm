...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_gpio_pin_val_read_gpio_pin_id_1_1:
	.ds 1
_gpio_pin_val_read_value_1_1:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;gpio_pin_id               Allocated with name '_gpio_pin_val_read_gpio_pin_id_1_1'
;value                     Allocated with name '_gpio_pin_val_read_value_1_1'
;------------------------------------------------------------
;	src/gpio_pin_val_read.c:46: bool gpio_pin_val_read(gpio_pin_id_t gpio_pin_id)
;	-----------------------------------------
...
_gpio_pin_val_read:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_gpio_pin_val_read_gpio_pin_id_1_1
	movx	@dptr,a
;	src/gpio_pin_val_read.c:48: bool value = false;
	mov	dptr,#_gpio_pin_val_read_value_1_1
	clr	a
	movx	@dptr,a
;	src/gpio_pin_val_read.c:51: if(gpio_pin_id <= GPIO_PIN_ID_P0_7)
	mov	dptr,#_gpio_pin_val_read_gpio_pin_id_1_1
	movx	a,@dptr
	mov  r7,a
	add	a,#0xff - 0x07
	jc	00110$
;	src/gpio_pin_val_read.c:53: value = P0 & (1 << (gpio_pin_id % 8));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00125$:
	...
	sjmp	00111$
00110$:
;	src/gpio_pin_val_read.c:55: else if(gpio_pin_id <= GPIO_PIN_ID_P1_7)
	mov	a,r7
	add	a,#0xff - 0x0F
	jc	00107$
;	src/gpio_pin_val_read.c:57: value = P1 & (1 << (gpio_pin_id % 8));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00129$:
	...
	sjmp	00111$
00107$:
;	src/gpio_pin_val_read.c:59: else if(gpio_pin_id <= GPIO_PIN_ID_P2_7)
	mov	a,r7
	add	a,#0xff - 0x17
	jc	00104$
;	src/gpio_pin_val_read.c:61: value = P2 & (1 << (gpio_pin_id % 8));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00133$:
	...
	sjmp	00111$
00104$:
;	src/gpio_pin_val_read.c:63: else if(gpio_pin_id <= GPIO_PIN_ID_P3_6)
	mov	a,r7
	add	a,#0xff - 0x1E
	jc	00111$
;	src/gpio_pin_val_read.c:65: value = P3 & (1 << (gpio_pin_id % 8));
	mov	a,#0x07
	anl	a,r7
	mov	b,a
	inc	b
...
00137$:
	...
	movx	@dptr,a
00111$:
;	src/gpio_pin_val_read.c:68: if(value)
	mov	dptr,#_gpio_pin_val_read_value_1_1
	movx	a,@dptr
	mov	r7,a
	jz	00113$
;	src/gpio_pin_val_read.c:70: return true;
	mov	dpl,#0x01
	ret
00113$:
;	src/gpio_pin_val_read.c:74: return false;
	mov	dpl,#0x00
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
