...
; This file was generated Fri Mar 23 15:39:11 2012
;--------------------------------------------------------
	.module pwr_clk_mgmt_get_cclk_freq_in_khz
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _pwr_clk_mgmt_get_cclk_freq_in_khz
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_pwr_clk_mgmt_get_cclk_freq_in_khz_cclk_freq_khz_1_1:
	.ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'pwr_clk_mgmt_get_cclk_freq_in_khz'
;------------------------------------------------------------
;divider                   Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_khz_divider_1_1'
;i                         Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_khz_i_1_1'
;cclk_freq_khz             Allocated with name '_pwr_clk_mgmt_get_cclk_freq_in_khz_cclk_freq_khz_1_1'
;------------------------------------------------------------
;	src/pwr_clk_mgmt_get_cclk_freq_in_khz.c:46: uint16_t pwr_clk_mgmt_get_cclk_freq_in_khz()
;	-----------------------------------------
;	 function pwr_clk_mgmt_get_cclk_freq_in_khz
;	-----------------------------------------
_pwr_clk_mgmt_get_cclk_freq_in_khz:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar1 = 0x01
	ar0 = 0x00
;	src/pwr_clk_mgmt_get_cclk_freq_in_khz.c:48: uint8_t divider = (CLKCTRL & CLKCTRL_CLK_FREQ_MASK) >> CLKCTRL_CLK_FREQ_SHIFT;
	mov	a,#0x07
	anl	a,_CLKCTRL
	mov	r7,a
;	src/pwr_clk_mgmt_get_cclk_freq_in_khz.c:50: uint16_t cclk_freq_khz = CCLK_MAX_FREQ_KHZ;
	mov	dptr,#_pwr_clk_mgmt_get_cclk_freq_in_khz_cclk_freq_khz_1_1
	mov	a,#0x80
	movx	@dptr,a
	inc	dptr
	mov	a,#0x3E
	movx	@dptr,a
;	src/pwr_clk_mgmt_get_cclk_freq_in_khz.c:52: for(i = 0; i < divider; i++)
	mov	r6,#0x00
00101$:
	clr	c
	mov	a,r6
	subb	a,r7
	jnc	00104$
;	src/pwr_clk_mgmt_get_cclk_freq_in_khz.c:54: cclk_freq_khz /= 2;
	mov	dptr,#_pwr_clk_mgmt_get_cclk_freq_in_khz_cclk_freq_khz_1_1
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
;	src/pwr_clk_mgmt_get_cclk_freq_in_khz.c:52: for(i = 0; i < divider; i++)
	...
	sjmp	00101$
00104$:
;	src/pwr_clk_mgmt_get_cclk_freq_in_khz.c:57: return cclk_freq_khz;
	mov	dptr,#_pwr_clk_mgmt_get_cclk_freq_in_khz_cclk_freq_khz_1_1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
