...
; This file was generated Fri Mar 23 15:39:12 2012
;--------------------------------------------------------
	.module timer2_calc_crc_val
...
;--------------------------------------------------------
	...
	.globl _SP
	.globl _P0
	.globl _timer2_calc_crc_val_PARM_2
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_timer2_calc_crc_val_PARM_2:
	.ds 1
_timer2_calc_crc_val_period_in_seconds_1_1:
	.ds 4
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'timer2_calc_crc_val'
;------------------------------------------------------------
;t2ps_bit_val              Allocated with name '_timer2_calc_crc_val_PARM_2'
;period_in_seconds         Allocated with name '_timer2_calc_crc_val_period_in_seconds_1_1'
;calc_crc_val_f            Allocated with name '_timer2_calc_crc_val_calc_crc_val_f_1_1'
;------------------------------------------------------------
;	src/timer2_calc_crc_val.c:49: uint16_t timer2_calc_crc_val(float period_in_seconds, bool t2ps_bit_val)
;	-----------------------------------------
;	 function timer2_calc_crc_val
;	-----------------------------------------
_timer2_calc_crc_val:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r5,b
	mov	r4,a
	mov	dptr,#_timer2_calc_crc_val_period_in_seconds_1_1
	mov	a,r7
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	...
	mov	a,r4
	movx	@dptr,a
;	src/timer2_calc_crc_val.c:59: calc_crc_val_f = (float)65536 - ((period_in_seconds * (float)pwr_clk_mgmt_get_cclk_freq_in_hz()) / ((float)(((t2ps_bit_val ? 2 : 1) * 12))));
...
00110$:
	...
	push	ar6
	push	ar7
;	src/timer2_calc_crc_val.c:62: if(calc_crc_val_f >= (float)65535)
	mov	dptr,#0x0000
	mov	b,#0x80
	mov	a,#0x47
	lcall	___fssub
	...
	mov	a,r3
	jnz	00105$
;	src/timer2_calc_crc_val.c:65: return 65535;
	mov	dptr,#0xFFFF
	ret
00105$:
;	src/timer2_calc_crc_val.c:67: else if(calc_crc_val_f <= (float)0)
	push	ar7
	push	ar6
	push	ar5
	push	ar4
	...
	mov	a,r3
	jnz	00102$
;	src/timer2_calc_crc_val.c:70: return 0;
	mov	dptr,#0x0000
	ret
00102$:
;	src/timer2_calc_crc_val.c:75: return ((uint16_t)(calc_crc_val_f + 0.5));
	clr	a
	push	acc
	push	acc
	push	acc
