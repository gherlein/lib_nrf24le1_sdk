...
; This file was generated Mon Mar 26 13:50:44 2012
;--------------------------------------------------------
	.module rf_read_rx_payload_width
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rf_read_rx_payload_width_dataptr_1_1:
	.ds 3
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'rf_read_rx_payload_width'
;------------------------------------------------------------
;dataptr                   Allocated with name '_rf_read_rx_payload_width_dataptr_1_1'
;status                    Allocated with name '_rf_read_rx_payload_width_status_1_1'
;------------------------------------------------------------
;	src/rf_read_rx_payload_width.c:47: uint8_t rf_read_rx_payload_width(uint8_t * dataptr)
;	-----------------------------------------
;	 function rf_read_rx_payload_width
;	-----------------------------------------
_rf_read_rx_payload_width:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_read_rx_payload_width_dataptr_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	movx	@dptr,a
	...
	mov	a,r7
	movx	@dptr,a
;	src/rf_read_rx_payload_width.c:51: status = rf_spi_execute_command(RF_R_RX_PL_WID, dataptr, 1, true);
	mov	dptr,#_rf_read_rx_payload_width_dataptr_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	movx	@dptr,a
	mov	dpl,#0x60
;	src/rf_read_rx_payload_width.c:53: return status; //Return the STATUS register value
