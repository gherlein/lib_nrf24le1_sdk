...
; This file was generated Mon Mar 26 13:50:23 2012
;--------------------------------------------------------
	.module rf_read_rx_payload
...
_rf_read_rx_payload_PARM_2:
	.ds 2
_rf_read_rx_payload_dataptr_1_1:
	.ds 3
;--------------------------------------------------------
...
;dataptr                   Allocated with name '_rf_read_rx_payload_dataptr_1_1'
;status                    Allocated with name '_rf_read_rx_payload_status_1_1'
;------------------------------------------------------------
;	src/rf_read_rx_payload.c:48: uint8_t rf_read_rx_payload(uint8_t * dataptr, uint16_t len)
;	-----------------------------------------
...
_rf_read_rx_payload:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_rf_read_rx_payload_dataptr_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,r6
	movx	@dptr,a
	...
	mov	a,r7
	movx	@dptr,a
;	src/rf_read_rx_payload.c:53: rf_clear_ce();
	 clr _RFCON_SB_RFCE 
;	src/rf_read_rx_payload.c:54: status = rf_spi_execute_command(RF_R_RX_PAYLOAD, dataptr, len, true);
	mov	dptr,#_rf_read_rx_payload_dataptr_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	r7,dpl
;	src/rf_read_rx_payload.c:55: rf_set_ce();
	 setb _RFCON_SB_RFCE 
	mov	dptr,#0x0004
	push	ar7
	lcall	_delay_us
	pop	ar7
;	src/rf_read_rx_payload.c:57: return status; //Return the STATUS register value
	mov	dpl,r7
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
