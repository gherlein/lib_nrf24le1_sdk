...
_rf_configure_PARM_23:
	.ds 1
_rf_configure_config_1_1:
	.ds 1
_rf_configure_buffer_1_1:
	.ds 5
;--------------------------------------------------------
...
;config                    Allocated with name '_rf_configure_config_1_1'
;buffer                    Allocated with name '_rf_configure_buffer_1_1'
;------------------------------------------------------------
...
_rf_configure:
	...
	ar1 = 0x01
	mov	a,dpl
	mov	dptr,#_rf_configure_config_1_1
	movx	@dptr,a
...
;	src/rf_configure.c:118: buffer[0] = en_aa;
	...
	movx	a,@dptr
	mov	dptr,#_rf_configure_buffer_1_1
	movx	@dptr,a
;	src/rf_configure.c:119: rf_write_register(RF_EN_AA, buffer, 1);
	mov	dptr,#_rf_write_register_PARM_2
	mov	a,#_rf_configure_buffer_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,#(_rf_configure_buffer_1_1 >> 8)
	movx	@dptr,a
	inc	dptr
	clr	a
	movx	@dptr,a
