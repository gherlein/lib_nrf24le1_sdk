...
; This file was generated Mon Mar 26 13:50:08 2012
;--------------------------------------------------------
	.module rf_configure_debug_lite
...
_rf_configure_debug_lite_PARM_2:
	.ds 1
_rf_configure_debug_lite_rx_1_1:
	.ds 1
_rf_configure_debug_lite_config_1_1:
	.ds 1
;--------------------------------------------------------
...
;rx                        Allocated with name '_rf_configure_debug_lite_rx_1_1'
;config                    Allocated with name '_rf_configure_debug_lite_config_1_1'
;------------------------------------------------------------
;	src/rf_configure_debug_lite.c:48: void rf_configure_debug_lite(bool rx, uint8_t p0_payload_width)
;	-----------------------------------------
...
_rf_configure_debug_lite:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_rf_configure_debug_lite_rx_1_1
	movx	@dptr,a
;	src/rf_configure_debug_lite.c:52: rf_spi_configure_enable(); //Enable RF SPI
	lcall	_rf_spi_configure_enable
;	src/rf_configure_debug_lite.c:55: config = 0;
	mov	dptr,#_rf_configure_debug_lite_config_1_1
	clr	a
	movx	@dptr,a
;	src/rf_configure_debug_lite.c:56: rf_write_register(RF_EN_AA, &config, 1); //Turn auto-acknowledge off
	mov	dptr,#_rf_write_register_PARM_2
	mov	a,#_rf_configure_debug_lite_config_1_1
	movx	@dptr,a
	inc	dptr
	mov	a,#(_rf_configure_debug_lite_config_1_1 >> 8)
	movx	@dptr,a
	inc	dptr
	clr	a
	movx	@dptr,a
...
;	src/rf_configure_debug_lite.c:59: config = RF_CONFIG_DEFAULT_VAL; //Set config to the default value of the CONFIG register
	mov	dptr,#_rf_configure_debug_lite_config_1_1
	mov	a,#0x08
	movx	@dptr,a
;	src/rf_configure_debug_lite.c:62: rf_write_register(RF_RX_PW_P0, &p0_payload_width, 1);
	mov	dptr,#_rf_write_register_PARM_2
	...
	mov	dpl,#0x11
	lcall	_rf_write_register
;	src/rf_configure_debug_lite.c:65: if(rx != false)
	mov	dptr,#_rf_configure_debug_lite_rx_1_1
	movx	a,@dptr
	mov	r7,a
	jz	00102$
;	src/rf_configure_debug_lite.c:67: config |= RF_CONFIG_PRIM_RX;
	mov	dptr,#_rf_configure_debug_lite_config_1_1
	mov	a,#0x09
	movx	@dptr,a
00102$:
;	src/rf_configure_debug_lite.c:70: rf_power_up_param(true, config);
	mov	dptr,#_rf_configure_debug_lite_config_1_1
	movx	a,@dptr
